...
public static boolean  _application_error(anywheresoftware.b4a.objects.B4AException _error,String _stacktrace) throws Exception{
 //BA.debugLineNum = 181;BA.debugLine="Sub Application_Error (Error As Exception, StackTr";
...
byte[] _data = null;
String _ds = "";
 //BA.debugLineNum = 44;BA.debugLine="Private Sub AutoDiscover_PacketArrived (Packet As";
 //BA.debugLineNum = 45;BA.debugLine="Try";
try { //BA.debugLineNum = 46;BA.debugLine="Dim bc As ByteConverter";
_bc = new anywheresoftware.b4a.agraham.byteconverter.ByteConverter();
 //BA.debugLineNum = 47;BA.debugLine="Dim data(Packet.Length) As Byte";
_data = new byte[_packet.getLength()];
;
 //BA.debugLineNum = 48;BA.debugLine="bc.ArrayCopy(Packet.Data, Packet.Offset, data, 0";
_bc.ArrayCopy((Object)(_packet.getData()),_packet.getOffset(),(Object)(_data),(int) (0),_packet.getLength());
 //BA.debugLineNum = 49;BA.debugLine="Dim ds As String = serializator.ConvertBytesToOb";
_ds = BA.ObjectToString(_serializator.ConvertBytesToObject(_data));
 //BA.debugLineNum = 50;BA.debugLine="CallSub2(Main, \"CheckIpExits\", ds)";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._main.getObject()),"CheckIpExits",(Object)(_ds));
 //BA.debugLineNum = 51;BA.debugLine="If ds <> DiscoveredServer Then";
if ((_ds).equals(_discoveredserver) == false) { 
 //BA.debugLineNum = 52;BA.debugLine="DiscoveredServer = ds";
_discoveredserver = _ds;
 //BA.debugLineNum = 54;BA.debugLine="If DiscoveredServer <> \"\" Then";
if ((_discoveredserver).equals("") == false) { 
 };
 };
 } 
       catch (Exception e13) {
			processBA.setLastException(e13); //BA.debugLineNum = 60;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("81179664",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
...
anywheresoftware.b4a.objects.SocketWrapper.UDPSocket.UDPPacket _up = null;
 //BA.debugLineNum = 35;BA.debugLine="Private Sub BroadcastTimer_Tick";
 //BA.debugLineNum = 36;BA.debugLine="Dim address As String = GetBroadcastAddress";
_address = _getbroadcastaddress();
 //BA.debugLineNum = 37;BA.debugLine="If address <> \"\" Then";
if ((_address).equals("") == false) { 
 //BA.debugLineNum = 38;BA.debugLine="Dim up As UDPPacket";
_up = new anywheresoftware.b4a.objects.SocketWrapper.UDPSocket.UDPPacket();
 //BA.debugLineNum = 39;BA.debugLine="up.Initialize(serializator.ConvertObjectToBytes(";
_up.Initialize(_serializator.ConvertObjectToBytes((Object)(_server.GetMyWifiIP())),_address,_discoverport);
 //BA.debugLineNum = 40;BA.debugLine="autodiscover.Send(up)";
...
public static String  _client_connected(boolean _success) throws Exception{
 //BA.debugLineNum = 91;BA.debugLine="Private Sub client_Connected (Success As Boolean)";
 //BA.debugLineNum = 92;BA.debugLine="Log($\"Connected: ${Success}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("81310721",("Connected: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_success))+""),0);
...
_connected = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 95;BA.debugLine="client.Subscribe(\"all/#\", 0)";
_client.Subscribe("all/#",(int) (0));
 //BA.debugLineNum = 96;BA.debugLine="client.Publish2(\"all/connect\", serializator.Conv";
_client.Publish2("all/connect",_serializator.ConvertObjectToBytes((Object)(_name)),(int) (0),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 98;BA.debugLine="ToastMessageShow(\"Error connecting: \" & LastExce";
...
public static String  _client_disconnected() throws Exception{
 //BA.debugLineNum = 150;BA.debugLine="Private Sub client_Disconnected";
 //BA.debugLineNum = 151;BA.debugLine="connected = False";
_connected = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 153;BA.debugLine="If isServer Then";
if (_isserver) { 
 };
...
nl.pdeg.bordondroid.main._message _m = null;
 //BA.debugLineNum = 102;BA.debugLine="Private Sub client_MessageArrived (Topic As String";
 //BA.debugLineNum = 103;BA.debugLine="Dim receivedObject As Object = serializator.Conve";
_receivedobject = _serializator.ConvertBytesToObject(_payload);
 //BA.debugLineNum = 104;BA.debugLine="If Topic = \"all/connect\" Or Topic = \"all/disconne";
if ((_topic).equals("all/connect") || (_topic).equals("all/disconnect")) { 
 //BA.debugLineNum = 106;BA.debugLine="Dim newUser As String = receivedObject";
_newuser = BA.ObjectToString(_receivedobject);
 //BA.debugLineNum = 107;BA.debugLine="If isServer Then";
if (_isserver) { 
 //BA.debugLineNum = 108;BA.debugLine="Log($\"${Topic}: ${newUser}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("81376262",(""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_topic))+": "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_newuser))+""),0);
 //BA.debugLineNum = 109;BA.debugLine="Dim index As Int = users.IndexOf(newUser)";
_index = _users.IndexOf((Object)(_newuser));
 //BA.debugLineNum = 110;BA.debugLine="If Topic.EndsWith(\"connect\") And index = -1 The";
if (_topic.endsWith("connect") && _index==-1) { 
_users.Add((Object)(_newuser));};
 //BA.debugLineNum = 111;BA.debugLine="If Topic.EndsWith(\"disconnect\") And index >= 0";
if (_topic.endsWith("disconnect") && _index>=0) { 
_users.RemoveAt(_index);};
 //BA.debugLineNum = 112;BA.debugLine="client.Publish2(\"all/users\", serializator.Conve";
_client.Publish2("all/users",_serializator.ConvertObjectToBytes((Object)(_users.getObject())),(int) (0),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 115;BA.debugLine="Dim newUsers As List = receivedObject";
_newusers = new anywheresoftware.b4a.objects.collections.List();
_newusers.setObject((java.util.List)(_receivedobject));
 }else {
 //BA.debugLineNum = 118;BA.debugLine="Dim m As Message = receivedObject";
_m = (nl.pdeg.bordondroid.main._message)(_receivedobject);
 //BA.debugLineNum = 121;BA.debugLine="CallSub2(ServerBoard, \"UpdateBordWhenClient\", m)";
...
anywheresoftware.b4j.objects.MqttAsyncClientWrapper.MqttConnectOptionsWrapper _mo = null;
 //BA.debugLineNum = 69;BA.debugLine="Public Sub Connect (AsServer As Boolean)";
 //BA.debugLineNum = 70;BA.debugLine="Dim host As String = DiscoveredServer";
_host = _discoveredserver;
 //BA.debugLineNum = 81;BA.debugLine="If connected Then client.Close";
if (_connected) { 
_client.Close();};
 //BA.debugLineNum = 83;BA.debugLine="client.Initialize(\"client\", $\"tcp://${host}:${por";
_client.Initialize(processBA,"client",("tcp://"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_host))+":"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_port))+""),"android"+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (10000000))));
 //BA.debugLineNum = 84;BA.debugLine="Dim mo As MqttConnectOptions";
_mo = new anywheresoftware.b4j.objects.MqttAsyncClientWrapper.MqttConnectOptionsWrapper();
 //BA.debugLineNum = 85;BA.debugLine="mo.Initialize(\"\", \"\")";
_mo.Initialize("","");
 //BA.debugLineNum = 87;BA.debugLine="mo.SetLastWill(\"all/disconnect\", serializator.Con";
_mo.SetLastWill("all/disconnect",_serializator.ConvertObjectToBytes((Object)(_name)),(int) (0),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 88;BA.debugLine="client.Connect2(mo)";
...
nl.pdeg.bordondroid.main._message _m = null;
 //BA.debugLineNum = 142;BA.debugLine="Private Sub CreateMessage(Body As String) As Byte(";
 //BA.debugLineNum = 143;BA.debugLine="Dim m As Message";
_m = new nl.pdeg.bordondroid.main._message();
 //BA.debugLineNum = 144;BA.debugLine="m.Initialize";
_m.Initialize();
 //BA.debugLineNum = 145;BA.debugLine="m.Body = Body";
_m.Body /*String*/  = _body;
 //BA.debugLineNum = 146;BA.debugLine="m.From = Name";
_m.From /*String*/  = _name;
 //BA.debugLineNum = 147;BA.debugLine="Return serializator.ConvertObjectToBytes(m)";
if (true) return _serializator.ConvertObjectToBytes((Object)(_m));
 //BA.debugLineNum = 148;BA.debugLine="End Sub";
return null;
}
public static String  _disconnect() throws Exception{
 //BA.debugLineNum = 132;BA.debugLine="Public Sub Disconnect";
 //BA.debugLineNum = 134;BA.debugLine="DiscoveredServer = \"\"";
_discoveredserver = "";
 //BA.debugLineNum = 136;BA.debugLine="If connected Then";
if (_connected) { 
 //BA.debugLineNum = 137;BA.debugLine="client.Publish2(\"all/disconnect\", serializator.C";
_client.Publish2("all/disconnect",_serializator.ConvertObjectToBytes((Object)(_name)),(int) (0),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 138;BA.debugLine="client.Close";
_client.Close();
 };
...
String _b = "";
 //BA.debugLineNum = 161;BA.debugLine="Private Sub GetBroadcastAddress As String";
 //BA.debugLineNum = 162;BA.debugLine="Dim niIterator As JavaObject";
_niiterator = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 163;BA.debugLine="niIterator = niIterator.InitializeStatic(\"java.";
_niiterator.setObject((java.lang.Object)(_niiterator.InitializeStatic("java.net.NetworkInterface").RunMethod("getNetworkInterfaces",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 164;BA.debugLine="Do While niIterator.RunMethod(\"hasMoreElements\"";
while (BA.ObjectToBoolean(_niiterator.RunMethod("hasMoreElements",(Object[])(anywheresoftware.b4a.keywords.Common.Null)))) {
 //BA.debugLineNum = 165;BA.debugLine="Dim ni As JavaObject = niIterator.RunMethod(\"";
...
_ni.setObject((java.lang.Object)(_niiterator.RunMethod("nextElement",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 166;BA.debugLine="If ni.RunMethod(\"isLoopback\", Null) = False T";
if ((_ni.RunMethod("isLoopback",(Object[])(anywheresoftware.b4a.keywords.Common.Null))).equals((Object)(anywheresoftware.b4a.keywords.Common.False))) { 
 //BA.debugLineNum = 167;BA.debugLine="Dim addresses As List = ni.RunMethod(\"getIn";
...
_addresses.setObject((java.util.List)(_ni.RunMethod("getInterfaceAddresses",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 168;BA.debugLine="For Each ia As JavaObject In addresses";
...
_ia.setObject((java.lang.Object)(group7.Get(index7)));
 //BA.debugLineNum = 169;BA.debugLine="Dim broadcast As Object = ia.RunMethod(\"g";
_broadcast = _ia.RunMethod("getBroadcast",(Object[])(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 170;BA.debugLine="If broadcast <> Null Then";
if (_broadcast!= null) { 
 //BA.debugLineNum = 171;BA.debugLine="Dim b As String = broadcast";
_b = BA.ObjectToString(_broadcast);
 //BA.debugLineNum = 172;BA.debugLine="Return b.SubString(1)";
...
_autodiscover = new anywheresoftware.b4a.objects.SocketWrapper.UDPSocket();
 //BA.debugLineNum = 21;BA.debugLine="Private server As ServerSocket 'ignore";
_server = new anywheresoftware.b4a.objects.SocketWrapper.ServerSocketWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Public serverList As List";
_serverlist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 23;BA.debugLine="Public serverDied As Long = 10000";
_serverdied = (long) (10000);
 //BA.debugLineNum = 24;BA.debugLine="End Sub";
return "";
}
public static String  _sendmessage(String _body) throws Exception{
 //BA.debugLineNum = 126;BA.debugLine="Public Sub SendMessage(Body As String)";
 //BA.debugLineNum = 127;BA.debugLine="If connected Then";
if (_connected) { 
 //BA.debugLineNum = 128;BA.debugLine="client.Publish2(\"all\", CreateMessage(Body), 0, F";
...
public static String  _service_create() throws Exception{
 ...
 //BA.debugLineNum = 29;BA.debugLine="users.Initialize";
_users.Initialize();
 //BA.debugLineNum = 30;BA.debugLine="autodiscover.Initialize(\"autodiscover\",discoverPo";
_autodiscover.Initialize(processBA,"autodiscover",_discoverport,(int) (8192));
 //BA.debugLineNum = 31;BA.debugLine="serverList.Initialize";
_serverlist.Initialize();
 //BA.debugLineNum = 33;BA.debugLine="End Sub";
return "";
}
public static String  _service_destroy() throws Exception{
 //BA.debugLineNum = 185;BA.debugLine="Sub Service_Destroy";
