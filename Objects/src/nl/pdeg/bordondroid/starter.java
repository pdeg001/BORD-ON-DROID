...
//C
this.state = 13;
 //BA.debugLineNum = 67;BA.debugLine="Log($\"Mqtt connected $DateTime{DateTime.Now}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("75505034",("Mqtt connected "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("datetime",(Object)(anywheresoftware.b4a.keywords.Common.DateTime.getNow()))+""),0);
...
anywheresoftware.b4a.keywords.Common.CallSubNew(processBA,(Object)(parent.mostCurrent._main.getObject()),"getBaseList");
 //BA.debugLineNum = 72;BA.debugLine="Do While pingMqtt And mqtt.Connected";
if (true) break;
...
parent._mqtt.Publish2("ping",new byte[]{(byte) (0)},(int) (1),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 74;BA.debugLine="Log($\"Mqtt $DateTime{DateTime.Now}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("75505041",("Mqtt "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("datetime",(Object)(anywheresoftware.b4a.keywords.Common.DateTime.getNow()))+""),0);
 //BA.debugLineNum = 75;BA.debugLine="Sleep(5000)";
...
this.state = 17;
;
 //BA.debugLineNum = 79;BA.debugLine="CallSub(ServerBoard, \"ConnectionLost\")";
anywheresoftware.b4a.keywords.Common.CallSubNew(processBA,(Object)(parent.mostCurrent._serverboard.getObject()),"ConnectionLost");
 //BA.debugLineNum = 80;BA.debugLine="CallSub(Main, \"ShowNotConnectedToBroker\")";
...
_appversion = "";
 //BA.debugLineNum = 29;BA.debugLine="Dim pingMqtt As Boolean";
_pingmqtt = false;
...
_basefilepath = anywheresoftware.b4a.keywords.Common.File.Combine(_storefolder,_basefile);
 //BA.debugLineNum = 41;BA.debugLine="pingMqtt = True";
