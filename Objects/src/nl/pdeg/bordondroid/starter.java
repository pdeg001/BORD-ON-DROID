...
RDebugUtils.currentLine=786439;
 //BA.debugLineNum = 786439;BA.debugLine="If serverList.IndexOf(ds) = -1 Then";
if (_serverlist.IndexOf((Object)(_ds))==-1) { 
RDebugUtils.currentLine=786440;
 //BA.debugLineNum = 786440;BA.debugLine="serverList.Add(ds)";
_serverlist.Add((Object)(_ds));
RDebugUtils.currentLine=786441;
 //BA.debugLineNum = 786441;BA.debugLine="Log($\"Discovered servers: ${serverList} $DateTi";
anywheresoftware.b4a.keywords.Common.LogImpl("5786441",("Discovered servers: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_serverlist.getObject()))+" "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("datetime",(Object)(anywheresoftware.b4a.keywords.Common.DateTime.getNow()))+""),0);
 };
RDebugUtils.currentLine=786443;
 //BA.debugLineNum = 786443;BA.debugLine="If ds <> DiscoveredServer Then";
if ((_ds).equals(_discoveredserver) == false) { 
RDebugUtils.currentLine=786444;
 //BA.debugLineNum = 786444;BA.debugLine="DiscoveredServer = ds";
_discoveredserver = _ds;
RDebugUtils.currentLine=786446;
 //BA.debugLineNum = 786446;BA.debugLine="If DiscoveredServer <> \"\" Then";
if ((_discoveredserver).equals("") == false) { 
 };
 };
 } 
       catch (Exception e16) {
			processBA.setLastException(e16);RDebugUtils.currentLine=786452;
 //BA.debugLineNum = 786452;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("5786452",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("5983041",("Connected: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_success))+""),0);
...
_brokerstarted = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.False);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("51048582",(""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_topic))+": "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_newuser))+""),0);
...
RDebugUtils.currentLine=655365;
 //BA.debugLineNum = 655365;BA.debugLine="serverList.Initialize";
