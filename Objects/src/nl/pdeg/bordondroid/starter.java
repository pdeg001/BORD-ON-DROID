...
public static boolean  _application_error(anywheresoftware.b4a.objects.B4AException _error,String _stacktrace) throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub Application_Error (Error As Exception, StackTr";
...
byte[] _data = null;
Object[] _ds = null;
 //BA.debugLineNum = 59;BA.debugLine="Private Sub AutoDiscover_PacketArrived (Packet As";
 //BA.debugLineNum = 60;BA.debugLine="If connected Then Return";
if (_connected) { 
if (true) return "";};
 //BA.debugLineNum = 61;BA.debugLine="Try";
try { //BA.debugLineNum = 62;BA.debugLine="Dim bc As ByteConverter";
_bc = new anywheresoftware.b4a.agraham.byteconverter.ByteConverter();
 //BA.debugLineNum = 63;BA.debugLine="Dim data(Packet.Length) As Byte";
_data = new byte[_packet.getLength()];
;
 //BA.debugLineNum = 64;BA.debugLine="bc.ArrayCopy(Packet.Data, Packet.Offset, data, 0";
_bc.ArrayCopy((Object)(_packet.getData()),_packet.getOffset(),(Object)(_data),(int) (0),_packet.getLength());
 //BA.debugLineNum = 65;BA.debugLine="Dim ds() As Object = serializator.ConvertBytesTo";
_ds = (Object[])(_serializator.ConvertBytesToObject(_data));
 //BA.debugLineNum = 66;BA.debugLine="Log(ds(0))";
anywheresoftware.b4a.keywords.Common.LogImpl("41507335",BA.ObjectToString(_ds[(int) (0)]),0);
 //BA.debugLineNum = 69;BA.debugLine="CallSub2(Main, \"CheckIpExits\", ds)";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._main.getObject()),"CheckIpExits",(Object)(_ds));
 } 
       catch (Exception e10) {
			processBA.setLastException(e10); //BA.debugLineNum = 79;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("41507348",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
...
anywheresoftware.b4a.objects.SocketWrapper.UDPSocket.UDPPacket _up = null;
 //BA.debugLineNum = 50;BA.debugLine="Private Sub BroadcastTimer_Tick";
 //BA.debugLineNum = 51;BA.debugLine="Dim address As String = GetBroadcastAddress";
_address = _getbroadcastaddress();
 //BA.debugLineNum = 52;BA.debugLine="If address <> \"\" Then";
if ((_address).equals("") == false) { 
 //BA.debugLineNum = 53;BA.debugLine="Dim up As UDPPacket";
_up = new anywheresoftware.b4a.objects.SocketWrapper.UDPSocket.UDPPacket();
 //BA.debugLineNum = 54;BA.debugLine="up.Initialize(serializator.ConvertObjectToBytes(";
_up.Initialize(_serializator.ConvertObjectToBytes((Object)(_server.GetMyWifiIP())),_address,_discoverport);
 //BA.debugLineNum = 55;BA.debugLine="autodiscover.Send(up)";
...
public static String  _client_connected(boolean _success) throws Exception{
 //BA.debugLineNum = 103;BA.debugLine="Private Sub client_Connected (Success As Boolean)";
 //BA.debugLineNum = 104;BA.debugLine="Log($\"Connected: ${Success}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("41638401",("Connected: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_success))+""),0);
 //BA.debugLineNum = 105;BA.debugLine="If Success Then";
if (_success) { 
 //BA.debugLineNum = 106;BA.debugLine="SendMessage(\"data please\")";
_sendmessage("data please");
 //BA.debugLineNum = 107;BA.debugLine="connectedTmr.Enabled = True";
...
_connected = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 110;BA.debugLine="client.Subscribe($\"${selectedBordName}/#\"$, 0)";
_client.Subscribe((""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_selectedbordname))+"/#"),(int) (0));
 //BA.debugLineNum = 113;BA.debugLine="client.Publish2(selectedBordName, serializator.C";
...
public static String  _client_disconnected() throws Exception{
 //BA.debugLineNum = 175;BA.debugLine="Private Sub client_Disconnected";
 //BA.debugLineNum = 176;BA.debugLine="connected = False";
...
nl.pdeg.bordondroid.main._message _m = null;
 //BA.debugLineNum = 121;BA.debugLine="Private Sub client_MessageArrived (Topic As String";
 //BA.debugLineNum = 122;BA.debugLine="Log(\"TOPIC \" & Topic)";
anywheresoftware.b4a.keywords.Common.LogImpl("41703937","TOPIC "+_topic,0);
 //BA.debugLineNum = 123;BA.debugLine="Dim receivedObject As Object = serializator.Conve";
_receivedobject = _serializator.ConvertBytesToObject(_payload);
 //BA.debugLineNum = 124;BA.debugLine="If Topic = \"all/connect\" Or Topic = \"all/disconne";
if ((_topic).equals("all/connect") || (_topic).equals("all/disconnect")) { 
 //BA.debugLineNum = 126;BA.debugLine="Dim newUser As String = receivedObject";
_newuser = BA.ObjectToString(_receivedobject);
 //BA.debugLineNum = 127;BA.debugLine="Log(newUser)";
anywheresoftware.b4a.keywords.Common.LogImpl("41703942",_newuser,0);
 //BA.debugLineNum = 128;BA.debugLine="If isServer Then";
if (_isserver) { 
 //BA.debugLineNum = 129;BA.debugLine="Log($\"${Topic}: ${newUser}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("41703944",(""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_topic))+": "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_newuser))+""),0);
 //BA.debugLineNum = 130;BA.debugLine="Dim index As Int = users.IndexOf(newUser)";
_index = _users.IndexOf((Object)(_newuser));
 //BA.debugLineNum = 131;BA.debugLine="If Topic.EndsWith(\"connect\") And index = -1 The";
if (_topic.endsWith("connect") && _index==-1) { 
_users.Add((Object)(_newuser));};
 //BA.debugLineNum = 132;BA.debugLine="If Topic.EndsWith(\"disconnect\") And index >= 0";
if (_topic.endsWith("disconnect") && _index>=0) { 
_users.RemoveAt(_index);};
 //BA.debugLineNum = 133;BA.debugLine="client.Publish2(\"all/users\", serializator.Conve";
_client.Publish2("all/users",_serializator.ConvertObjectToBytes((Object)(_users.getObject())),(int) (0),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 136;BA.debugLine="Dim newUsers As List = receivedObject";
_newusers = new anywheresoftware.b4a.objects.collections.List();
_newusers.setObject((java.util.List)(_receivedobject));
 }else {
 //BA.debugLineNum = 141;BA.debugLine="Dim m As Message = receivedObject";
_m = (nl.pdeg.bordondroid.main._message)(_receivedobject);
 //BA.debugLineNum = 143;BA.debugLine="Log(m)";
anywheresoftware.b4a.keywords.Common.LogImpl("41703958",BA.ObjectToString(_m),0);
 //BA.debugLineNum = 145;BA.debugLine="CallSub2(ServerBoard, \"UpdateBordWhenClient\", m)";
...
anywheresoftware.b4j.objects.MqttAsyncClientWrapper.MqttConnectOptionsWrapper _mo = null;
 //BA.debugLineNum = 88;BA.debugLine="Public Sub Connect (AsServer As Boolean)";
 //BA.debugLineNum = 89;BA.debugLine="Dim host As String' = DiscoveredServer";
_host = "";
 //BA.debugLineNum = 90;BA.debugLine="host = \"pdeg3005.mynetgear.com\"";
_host = "pdeg3005.mynetgear.com";
 //BA.debugLineNum = 91;BA.debugLine="Log(\"HOST : \" & host)";
anywheresoftware.b4a.keywords.Common.LogImpl("41572867","HOST : "+_host,0);
 //BA.debugLineNum = 93;BA.debugLine="If connected Then client.Close";
if (_connected) { 
_client.Close();};
 //BA.debugLineNum = 95;BA.debugLine="client.Initialize(\"client\", $\"tcp://${host}:${por";
_client.Initialize(processBA,"client",("tcp://"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_host))+":"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_port))+""),"android"+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (10000000))));
 //BA.debugLineNum = 96;BA.debugLine="Dim mo As MqttConnectOptions";
_mo = new anywheresoftware.b4j.objects.MqttAsyncClientWrapper.MqttConnectOptionsWrapper();
 //BA.debugLineNum = 97;BA.debugLine="mo.Initialize(\"\", \"\")";
_mo.Initialize("","");
 //BA.debugLineNum = 99;BA.debugLine="mo.SetLastWill(\"all/disconnect\", serializator.Con";
_mo.SetLastWill("all/disconnect",_serializator.ConvertObjectToBytes((Object)(_p.getModel())),(int) (0),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 100;BA.debugLine="client.Connect2(mo)";
...
public static String  _connected_tick() throws Exception{
 //BA.debugLineNum = 42;BA.debugLine="Sub connected_Tick";
 //BA.debugLineNum = 43;BA.debugLine="If client.Connected = False Then";
if (_client.getConnected()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 44;BA.debugLine="connectedTmr.Enabled = False";
_connectedtmr.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 45;BA.debugLine="CallSub(ServerBoard, \"ConnectionLost\")";
...
nl.pdeg.bordondroid.main._message _m = null;
 //BA.debugLineNum = 167;BA.debugLine="Private Sub CreateMessage(Body As String) As Byte(";
 //BA.debugLineNum = 168;BA.debugLine="Dim m As Message";
_m = new nl.pdeg.bordondroid.main._message();
 //BA.debugLineNum = 169;BA.debugLine="m.Initialize";
_m.Initialize();
 //BA.debugLineNum = 170;BA.debugLine="m.Body = Body";
_m.Body /*String*/  = _body;
 //BA.debugLineNum = 171;BA.debugLine="m.From = Name";
_m.From /*String*/  = _name;
 //BA.debugLineNum = 172;BA.debugLine="Return serializator.ConvertObjectToBytes(m)";
if (true) return _serializator.ConvertObjectToBytes((Object)(_m));
 //BA.debugLineNum = 173;BA.debugLine="End Sub";
return null;
}
public static String  _disconnect() throws Exception{
 //BA.debugLineNum = 156;BA.debugLine="Public Sub Disconnect";
 //BA.debugLineNum = 158;BA.debugLine="DiscoveredServer = \"\"";
_discoveredserver = "";
 //BA.debugLineNum = 160;BA.debugLine="If connected Then";
if (_connected) { 
 //BA.debugLineNum = 161;BA.debugLine="client.Publish2(\"all/disconnect\", serializator.C";
_client.Publish2("all/disconnect",_serializator.ConvertObjectToBytes((Object)(_name)),(int) (0),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 162;BA.debugLine="client.Close";
_client.Close();
...
String _b = "";
 //BA.debugLineNum = 186;BA.debugLine="Private Sub GetBroadcastAddress As String";
 //BA.debugLineNum = 187;BA.debugLine="Dim niIterator As JavaObject";
_niiterator = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 188;BA.debugLine="niIterator = niIterator.InitializeStatic(\"java.";
_niiterator.setObject((java.lang.Object)(_niiterator.InitializeStatic("java.net.NetworkInterface").RunMethod("getNetworkInterfaces",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 189;BA.debugLine="Do While niIterator.RunMethod(\"hasMoreElements\"";
while (BA.ObjectToBoolean(_niiterator.RunMethod("hasMoreElements",(Object[])(anywheresoftware.b4a.keywords.Common.Null)))) {
 //BA.debugLineNum = 190;BA.debugLine="Dim ni As JavaObject = niIterator.RunMethod(\"";
...
_ni.setObject((java.lang.Object)(_niiterator.RunMethod("nextElement",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 191;BA.debugLine="If ni.RunMethod(\"isLoopback\", Null) = False T";
if ((_ni.RunMethod("isLoopback",(Object[])(anywheresoftware.b4a.keywords.Common.Null))).equals((Object)(anywheresoftware.b4a.keywords.Common.False))) { 
 //BA.debugLineNum = 192;BA.debugLine="Dim addresses As List = ni.RunMethod(\"getIn";
...
_addresses.setObject((java.util.List)(_ni.RunMethod("getInterfaceAddresses",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 193;BA.debugLine="For Each ia As JavaObject In addresses";
...
_ia.setObject((java.lang.Object)(group7.Get(index7)));
 //BA.debugLineNum = 194;BA.debugLine="Dim broadcast As Object = ia.RunMethod(\"g";
_broadcast = _ia.RunMethod("getBroadcast",(Object[])(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 195;BA.debugLine="If broadcast <> Null Then";
if (_broadcast!= null) { 
 //BA.debugLineNum = 196;BA.debugLine="Dim b As String = broadcast";
_b = BA.ObjectToString(_broadcast);
 //BA.debugLineNum = 197;BA.debugLine="Return b.SubString(1)";
...
_client = new anywheresoftware.b4j.objects.MqttAsyncClientWrapper();
 //BA.debugLineNum = 10;BA.debugLine="Private const port As Int = 1883   '51042";
_port = (int) (1883);
...
_selectedbordname = "";
 //BA.debugLineNum = 27;BA.debugLine="Private topicName As String";
_topicname = "";
 //BA.debugLineNum = 28;BA.debugLine="Public mqttGetBordsActive, mqttGetBordDataActive";
...
public static String  _sendmessage(String _body) throws Exception{
 //BA.debugLineNum = 150;BA.debugLine="Public Sub SendMessage(Body As String)";
 //BA.debugLineNum = 151;BA.debugLine="If connected Then";
if (_connected) { 
 //BA.debugLineNum = 152;BA.debugLine="client.Publish2(\"all\", CreateMessage(Body), 0, F";
...
public static String  _service_create() throws Exception{
 ...
 //BA.debugLineNum = 32;BA.debugLine="connectedTmr.Initialize(\"connected\", 3000)";
_connectedtmr.Initialize(processBA,"connected",(long) (3000));
 //BA.debugLineNum = 35;BA.debugLine="users.Initialize";
_users.Initialize();
 //BA.debugLineNum = 36;BA.debugLine="autodiscover.Initialize(\"autodiscover\",discoverPo";
...
_serverlist.Initialize();
 //BA.debugLineNum = 39;BA.debugLine="Name = p.Model";
_name = _p.getModel();
 //BA.debugLineNum = 40;BA.debugLine="End Sub";
return "";
}
public static String  _service_destroy() throws Exception{
 //BA.debugLineNum = 210;BA.debugLine="Sub Service_Destroy";
 //BA.debugLineNum = 212;BA.debugLine="End Sub";
return "";
}
public static String  _service_start(anywheresoftware.b4a.objects.IntentWrapper _startingintent) throws Exception{
 //BA.debugLineNum = 83;BA.debugLine="Sub Service_Start (StartingIntent As Intent)";
