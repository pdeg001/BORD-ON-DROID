...
public static boolean  _application_error(anywheresoftware.b4a.objects.B4AException _error,String _stacktrace) throws Exception{
 //BA.debugLineNum = 177;BA.debugLine="Sub Application_Error (Error As Exception, StackTr";
...
_ds = BA.ObjectToString(_serializator.ConvertBytesToObject(_data));
 //BA.debugLineNum = 46;BA.debugLine="Log(\"Discovered server: \" & DiscoveredServer)";
anywheresoftware.b4a.keywords.Common.LogImpl("1786438","Discovered server: "+_discoveredserver,0);
 //BA.debugLineNum = 47;BA.debugLine="If ds <> DiscoveredServer Then";
if ((_ds).equals(_discoveredserver) == false) { 
 //BA.debugLineNum = 48;BA.debugLine="DiscoveredServer = ds";
_discoveredserver = _ds;
 //BA.debugLineNum = 49;BA.debugLine="Log(\"Discovered server: \" & DiscoveredServer)";
anywheresoftware.b4a.keywords.Common.LogImpl("1786441","Discovered server: "+_discoveredserver,0);
 //BA.debugLineNum = 50;BA.debugLine="If DiscoveredServer <> \"\" Then";
if ((_discoveredserver).equals("") == false) { 
 //BA.debugLineNum = 51;BA.debugLine="Connect(False)";
_connect(anywheresoftware.b4a.keywords.Common.False);
 };
 };
 } 
       catch (Exception e15) {
			processBA.setLastException(e15); //BA.debugLineNum = 56;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("1786448",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
...
public static String  _client_connected(boolean _success) throws Exception{
 //BA.debugLineNum = 87;BA.debugLine="Private Sub client_Connected (Success As Boolean)";
 //BA.debugLineNum = 88;BA.debugLine="Log($\"Connected: ${Success}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("1983041",("Connected: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_success))+""),0);
 //BA.debugLineNum = 89;BA.debugLine="If Success Then";
if (_success) { 
 //BA.debugLineNum = 90;BA.debugLine="connected = True";
_connected = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 91;BA.debugLine="client.Subscribe(\"all/#\", 0)";
_client.Subscribe("all/#",(int) (0));
 //BA.debugLineNum = 92;BA.debugLine="client.Publish2(\"all/connect\", serializator.Conv";
_client.Publish2("all/connect",_serializator.ConvertObjectToBytes((Object)(_name)),(int) (0),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 94;BA.debugLine="ToastMessageShow(\"Error connecting: \" & LastExce";
...
public static String  _client_disconnected() throws Exception{
 //BA.debugLineNum = 146;BA.debugLine="Private Sub client_Disconnected";
 //BA.debugLineNum = 147;BA.debugLine="connected = False";
_connected = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 149;BA.debugLine="If isServer Then";
if (_isserver) { 
 //BA.debugLineNum = 150;BA.debugLine="broker.Stop";
_broker.Stop();
 //BA.debugLineNum = 151;BA.debugLine="brokerStarted = False";
...
nl.pdeg.bordondroid.main._message _m = null;
 //BA.debugLineNum = 98;BA.debugLine="Private Sub client_MessageArrived (Topic As String";
 //BA.debugLineNum = 99;BA.debugLine="Dim receivedObject As Object = serializator.Conve";
_receivedobject = _serializator.ConvertBytesToObject(_payload);
 //BA.debugLineNum = 100;BA.debugLine="If Topic = \"all/connect\" Or Topic = \"all/disconne";
if ((_topic).equals("all/connect") || (_topic).equals("all/disconnect")) { 
 //BA.debugLineNum = 102;BA.debugLine="Dim newUser As String = receivedObject";
_newuser = BA.ObjectToString(_receivedobject);
 //BA.debugLineNum = 103;BA.debugLine="If isServer Then";
if (_isserver) { 
 //BA.debugLineNum = 104;BA.debugLine="Log($\"${Topic}: ${newUser}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("11048582",(""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_topic))+": "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_newuser))+""),0);
 //BA.debugLineNum = 105;BA.debugLine="Dim index As Int = users.IndexOf(newUser)";
_index = _users.IndexOf((Object)(_newuser));
 //BA.debugLineNum = 106;BA.debugLine="If Topic.EndsWith(\"connect\") And index = -1 The";
if (_topic.endsWith("connect") && _index==-1) { 
_users.Add((Object)(_newuser));};
 //BA.debugLineNum = 107;BA.debugLine="If Topic.EndsWith(\"disconnect\") And index >= 0";
if (_topic.endsWith("disconnect") && _index>=0) { 
_users.RemoveAt(_index);};
 //BA.debugLineNum = 108;BA.debugLine="client.Publish2(\"all/users\", serializator.Conve";
_client.Publish2("all/users",_serializator.ConvertObjectToBytes((Object)(_users.getObject())),(int) (0),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 111;BA.debugLine="Dim newUsers As List = receivedObject";
_newusers = new anywheresoftware.b4a.objects.collections.List();
_newusers.setObject((java.util.List)(_receivedobject));
 }else {
 //BA.debugLineNum = 114;BA.debugLine="Dim m As Message = receivedObject";
_m = (nl.pdeg.bordondroid.main._message)(_receivedobject);
 //BA.debugLineNum = 117;BA.debugLine="CallSub2(ServerBoard, \"UpdateBordWhenClient\", m)";
...
anywheresoftware.b4j.objects.MqttAsyncClientWrapper.MqttConnectOptionsWrapper _mo = null;
 //BA.debugLineNum = 65;BA.debugLine="Public Sub Connect (AsServer As Boolean)";
 //BA.debugLineNum = 66;BA.debugLine="Dim host As String = DiscoveredServer";
_host = _discoveredserver;
 //BA.debugLineNum = 67;BA.debugLine="isServer = AsServer";
_isserver = _asserver;
 //BA.debugLineNum = 68;BA.debugLine="If isServer Then";
if (_isserver) { 
 //BA.debugLineNum = 69;BA.debugLine="If brokerStarted = False Then";
if (_brokerstarted==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 70;BA.debugLine="broker.Start";
_broker.Start();
 //BA.debugLineNum = 71;BA.debugLine="brokerStarted = True";
_brokerstarted = anywheresoftware.b4a.keywords.Common.True;
 };
 //BA.debugLineNum = 73;BA.debugLine="users.Clear";
_users.Clear();
 //BA.debugLineNum = 74;BA.debugLine="host = \"127.0.0.1\"";
_host = "127.0.0.1";
 };
 //BA.debugLineNum = 76;BA.debugLine="BroadcastTimer.Enabled = isServer";
_broadcasttimer.setEnabled(_isserver);
 //BA.debugLineNum = 77;BA.debugLine="If connected Then client.Close";
if (_connected) { 
_client.Close();};
 //BA.debugLineNum = 79;BA.debugLine="client.Initialize(\"client\", $\"tcp://${host}:${por";
_client.Initialize(processBA,"client",("tcp://"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_host))+":"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_port))+""),"android"+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (10000000))));
 //BA.debugLineNum = 80;BA.debugLine="Dim mo As MqttConnectOptions";
_mo = new anywheresoftware.b4j.objects.MqttAsyncClientWrapper.MqttConnectOptionsWrapper();
 //BA.debugLineNum = 81;BA.debugLine="mo.Initialize(\"\", \"\")";
_mo.Initialize("","");
 //BA.debugLineNum = 83;BA.debugLine="mo.SetLastWill(\"all/disconnect\", serializator.Con";
_mo.SetLastWill("all/disconnect",_serializator.ConvertObjectToBytes((Object)(_name)),(int) (0),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 84;BA.debugLine="client.Connect2(mo)";
...
nl.pdeg.bordondroid.main._message _m = null;
 //BA.debugLineNum = 138;BA.debugLine="Private Sub CreateMessage(Body As String) As Byte(";
 //BA.debugLineNum = 139;BA.debugLine="Dim m As Message";
_m = new nl.pdeg.bordondroid.main._message();
 //BA.debugLineNum = 140;BA.debugLine="m.Initialize";
_m.Initialize();
 //BA.debugLineNum = 141;BA.debugLine="m.Body = Body";
_m.Body /*String*/  = _body;
 //BA.debugLineNum = 142;BA.debugLine="m.From = Name";
_m.From /*String*/  = _name;
 //BA.debugLineNum = 143;BA.debugLine="Return serializator.ConvertObjectToBytes(m)";
if (true) return _serializator.ConvertObjectToBytes((Object)(_m));
 //BA.debugLineNum = 144;BA.debugLine="End Sub";
return null;
}
public static String  _disconnect() throws Exception{
 //BA.debugLineNum = 128;BA.debugLine="Public Sub Disconnect";
 //BA.debugLineNum = 129;BA.debugLine="BroadcastTimer.Enabled = False";
_broadcasttimer.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 130;BA.debugLine="DiscoveredServer = \"\"";
_discoveredserver = "";
 //BA.debugLineNum = 132;BA.debugLine="If connected Then";
if (_connected) { 
 //BA.debugLineNum = 133;BA.debugLine="client.Publish2(\"all/disconnect\", serializator.C";
_client.Publish2("all/disconnect",_serializator.ConvertObjectToBytes((Object)(_name)),(int) (0),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 134;BA.debugLine="client.Close";
_client.Close();
 };
...
String _b = "";
 //BA.debugLineNum = 157;BA.debugLine="Private Sub GetBroadcastAddress As String";
 //BA.debugLineNum = 158;BA.debugLine="Dim niIterator As JavaObject";
_niiterator = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 159;BA.debugLine="niIterator = niIterator.InitializeStatic(\"java.";
_niiterator.setObject((java.lang.Object)(_niiterator.InitializeStatic("java.net.NetworkInterface").RunMethod("getNetworkInterfaces",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 160;BA.debugLine="Do While niIterator.RunMethod(\"hasMoreElements\"";
while (BA.ObjectToBoolean(_niiterator.RunMethod("hasMoreElements",(Object[])(anywheresoftware.b4a.keywords.Common.Null)))) {
 //BA.debugLineNum = 161;BA.debugLine="Dim ni As JavaObject = niIterator.RunMethod(\"";
...
_ni.setObject((java.lang.Object)(_niiterator.RunMethod("nextElement",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 162;BA.debugLine="If ni.RunMethod(\"isLoopback\", Null) = False T";
if ((_ni.RunMethod("isLoopback",(Object[])(anywheresoftware.b4a.keywords.Common.Null))).equals((Object)(anywheresoftware.b4a.keywords.Common.False))) { 
 //BA.debugLineNum = 163;BA.debugLine="Dim addresses As List = ni.RunMethod(\"getIn";
...
_addresses.setObject((java.util.List)(_ni.RunMethod("getInterfaceAddresses",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 164;BA.debugLine="For Each ia As JavaObject In addresses";
...
_ia.setObject((java.lang.Object)(group7.Get(index7)));
 //BA.debugLineNum = 165;BA.debugLine="Dim broadcast As Object = ia.RunMethod(\"g";
_broadcast = _ia.RunMethod("getBroadcast",(Object[])(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 166;BA.debugLine="If broadcast <> Null Then";
if (_broadcast!= null) { 
 //BA.debugLineNum = 167;BA.debugLine="Dim b As String = broadcast";
_b = BA.ObjectToString(_broadcast);
 //BA.debugLineNum = 168;BA.debugLine="Return b.SubString(1)";
...
public static String  _sendmessage(String _body) throws Exception{
 //BA.debugLineNum = 122;BA.debugLine="Public Sub SendMessage(Body As String)";
 //BA.debugLineNum = 123;BA.debugLine="If connected Then";
if (_connected) { 
 //BA.debugLineNum = 124;BA.debugLine="client.Publish2(\"all\", CreateMessage(Body), 0, F";
...
public static String  _service_destroy() throws Exception{
 //BA.debugLineNum = 181;BA.debugLine="Sub Service_Destroy";
