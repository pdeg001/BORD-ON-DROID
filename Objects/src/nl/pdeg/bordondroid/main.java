...
mostCurrent._activity.LoadLayout("main",mostCurrent.activityBA);
 //BA.debugLineNum = 59;BA.debugLine="mqttBase.Initialize";
_mqttbase._initialize /*String*/ (processBA);
 //BA.debugLineNum = 61;BA.debugLine="Starter.appVersion = $\"${Application.LabelName} v";
...
if (true) return anywheresoftware.b4a.keywords.Common.False;
 ...
 //BA.debugLineNum = 288;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
...
mostCurrent._starter._mainpaused /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 95;BA.debugLine="ResumeConnection(False)";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 68;BA.debugLine="ShowSelectLocationButton";
_showselectlocationbutton();
 //BA.debugLineNum = 69;BA.debugLine="If Starter.mainPaused Then";
if (mostCurrent._starter._mainpaused /*boolean*/ ) { 
 //BA.debugLineNum = 70;BA.debugLine="ResumeConnection(True)";
_resumeconnection(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 71;BA.debugLine="Starter.mainPaused = False";
mostCurrent._starter._mainpaused /*boolean*/  = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 72;BA.debugLine="Starter.pingMqtt = True";
mostCurrent._starter._pingmqtt /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 73;BA.debugLine="Starter.ConnectAndReconnect";
...
//C
this.state = 1;
 //BA.debugLineNum = 358;BA.debugLine="Dim bordStatus As bordStatus";
_bordstatus = new nl.pdeg.bordondroid.main._bordstatus();
 //BA.debugLineNum = 359;BA.debugLine="bordStatus.Initialize";
_bordstatus.Initialize();
 //BA.debugLineNum = 360;BA.debugLine="bordStatus.ip = ip";
_bordstatus.ip /*String*/  = _ip;
 //BA.debugLineNum = 361;BA.debugLine="bordStatus.name = name";
_bordstatus.name /*String*/  = _name;
 //BA.debugLineNum = 362;BA.debugLine="bordStatus.timeStamp = DateTime.Now";
_bordstatus.timeStamp /*long*/  = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 363;BA.debugLine="bordStatus.alive = True";
_bordstatus.alive /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 364;BA.debugLine="Starter.serverList.Add(bordStatus)";
parent.mostCurrent._starter._serverlist /*anywheresoftware.b4a.objects.collections.List*/ .Add((Object)(_bordstatus));
 //BA.debugLineNum = 365;BA.debugLine="CheckIpInClv(bordStatus)";
_checkipinclv(_bordstatus);
 //BA.debugLineNum = 366;BA.debugLine="baseFile.SetBordDiedByName(name, clvServer, True)";
parent._basefile._setborddiedbyname /*String*/ (_name,parent.mostCurrent._clvserver,anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 368;BA.debugLine="If clvServer.GetSize > 0 Then";
if (true) break;
...
//C
this.state = 6;
 //BA.debugLineNum = 369;BA.debugLine="pnlNobords.SetVisibleAnimated(500, False)";
...
//C
this.state = 6;
 //BA.debugLineNum = 371;BA.debugLine="pnlNobords.SetVisibleAnimated(500, True)";
...
this.state = -1;
;
 //BA.debugLineNum = 375;BA.debugLine="Sleep(400)";
...
//C
this.state = 1;
 //BA.debugLineNum = 428;BA.debugLine="Msgbox2Async(\"Applicatie afsluiten?\", Application";
...
//C
this.state = 1;
 //BA.debugLineNum = 436;BA.debugLine="If edtFloatCode.Text = \"\" Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 437;BA.debugLine="Msgbox2Async(\"Locatie code mag niet leeg zijn\",";
...
this.state = 5;
;
 //BA.debugLineNum = 442;BA.debugLine="Dim ime As IME";
_ime = new anywheresoftware.b4a.objects.IME();
 //BA.debugLineNum = 443;BA.debugLine="ime.Initialize(Me)";
_ime.Initialize(BA.ObjectToString(main.getObject()));
 //BA.debugLineNum = 444;BA.debugLine="Starter.testBaseName = True";
parent.mostCurrent._starter._testbasename /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 445;BA.debugLine="Starter.selectedLocationCode = edtFloatCode.Text";
parent.mostCurrent._starter._selectedlocationcode /*String*/  = parent.mostCurrent._edtfloatcode._gettext /*String*/ ();
 //BA.debugLineNum = 447;BA.debugLine="Starter.SetLastWill(\"bordpubdied\")";
parent.mostCurrent._starter._setlastwill /*String*/ ("bordpubdied");
 //BA.debugLineNum = 449;BA.debugLine="Starter.SetSubBase(Starter.selectedLocationCode)";
parent.mostCurrent._starter._setsubbase /*String*/ (parent.mostCurrent._starter._selectedlocationcode /*String*/ );
 //BA.debugLineNum = 451;BA.debugLine="Starter.SetSubString2(\"/pubbord\")";
parent.mostCurrent._starter._setsubstring2 /*String*/ ("/pubbord");
 //BA.debugLineNum = 453;BA.debugLine="Starter.SetUnsubscribeString2(\"\")";
parent.mostCurrent._starter._setunsubscribestring2 /*String*/ ("");
 //BA.debugLineNum = 454;BA.debugLine="mqttBase.Initialize";
parent._mqttbase._initialize /*String*/ (processBA);
 //BA.debugLineNum = 455;BA.debugLine="Sleep(100)";
...
this.state = 5;
;
 //BA.debugLineNum = 456;BA.debugLine="mqttBase.Connect";
parent._mqttbase._connect /*String*/ ();
 //BA.debugLineNum = 458;BA.debugLine="Sleep(1000)";
...
this.state = 5;
;
 //BA.debugLineNum = 460;BA.debugLine="If mqttBase.connected = False Then";
if (true) break;
...
//C
this.state = 16;
 //BA.debugLineNum = 461;BA.debugLine="Msgbox2Async(\"Kan geen verbinding maken met loca";
anywheresoftware.b4a.keywords.Common.Msgbox2Async(BA.ObjectToCharSequence("Kan geen verbinding maken met locatie"),BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.Application.getLabelName()),"OKE","","",anywheresoftware.b4a.keywords.Common.Application.getIcon(),processBA,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 462;BA.debugLine="Wait For Msgbox_Result(Result As Int)";
anywheresoftware.b4a.keywords.Common.WaitFor("msgbox_result", processBA, this, null);
this.state = 20;
return;
case 20:
...
//C
this.state = 10;
 //BA.debugLineNum = 464;BA.debugLine="Dim code, description As String";
_code = "";
_description = "";
 //BA.debugLineNum = 465;BA.debugLine="lblCurrLocation.Text = edtFloatDescription.Text";
parent.mostCurrent._lblcurrlocation.setText(BA.ObjectToCharSequence(parent.mostCurrent._edtfloatdescription._gettext /*String*/ ()));
 //BA.debugLineNum = 466;BA.debugLine="Starter.selectedLocationDescription = edtFloatDe";
parent.mostCurrent._starter._selectedlocationdescription /*String*/  = parent.mostCurrent._edtfloatdescription._gettext /*String*/ ();
 //BA.debugLineNum = 467;BA.debugLine="code = edtFloatCode.Text";
_code = parent.mostCurrent._edtfloatcode._gettext /*String*/ ();
 //BA.debugLineNum = 468;BA.debugLine="If edtFloatDescription.Text = \"\" Then edtFloatDe";
if (true) break;
...
this.state = 16;
;
 //BA.debugLineNum = 469;BA.debugLine="description = edtFloatDescription.Text";
_description = parent.mostCurrent._edtfloatdescription._gettext /*String*/ ();
 //BA.debugLineNum = 472;BA.debugLine="mqttBase.Disconnect";
parent._mqttbase._disconnect /*String*/ ();
 //BA.debugLineNum = 473;BA.debugLine="pnlLocationCOde.Visible = False";
parent.mostCurrent._pnllocationcode.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 474;BA.debugLine="baseFile.SetBase(code, description, \"1\")";
parent._basefile._setbase /*String*/ (_code,_description,"1");
 //BA.debugLineNum = 475;BA.debugLine="InitConnection";
_initconnection();
 //BA.debugLineNum = 476;BA.debugLine="ime.HideKeyboard";
...
public static boolean  _checkclientconnected() throws Exception{
 //BA.debugLineNum = 496;BA.debugLine="Private Sub CheckClientConnected As Boolean";
 //BA.debugLineNum = 497;BA.debugLine="Return CallSub(mqttBase, \"GetClientConnected\")";
...
public static boolean  _checkconnecttime() throws Exception{
 //BA.debugLineNum = 220;BA.debugLine="Sub checkConnectTime As Boolean";
 //BA.debugLineNum = 221;BA.debugLine="If connectTime <> -1 Then";
if (_connecttime!=-1) { 
 //BA.debugLineNum = 222;BA.debugLine="pnlNobords.Visible = True";
mostCurrent._pnlnobords.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 223;BA.debugLine="mqttBase.Disconnect";
_mqttbase._disconnect /*String*/ ();
 //BA.debugLineNum = 224;BA.debugLine="tmrBordLastAlive.Enabled = False";
_tmrbordlastalive.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 225;BA.debugLine="pnlNobords.Visible = False";
mostCurrent._pnlnobords.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 226;BA.debugLine="Msgbox2Async(\"Geen borden gevonden\", Application";
...
nl.pdeg.bordondroid.main._bordstatus _lst = null;
 //BA.debugLineNum = 318;BA.debugLine="Sub CheckIpExits(bord As Message)";
 //BA.debugLineNum = 319;BA.debugLine="Dim bordExists As Boolean = False";
_bordexists = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 321;BA.debugLine="If bord.Body.Length = 0 Then Return";
if (_bord.Body /*String*/ .length()==0) { 
if (true) return "";};
 //BA.debugLineNum = 322;BA.debugLine="Dim name As String = bord.Body";
_name = _bord.Body /*String*/ ;
 //BA.debugLineNum = 323;BA.debugLine="connectTime = -1";
_connecttime = (long) (-1);
...
if (mostCurrent._starter._serverlist /*anywheresoftware.b4a.objects.collections.List*/ .getSize()==0) { 
 //BA.debugLineNum = 326;BA.debugLine="AddUnkownIp(\"\", name)";
_addunkownip("",_name);
...
_lst.alive /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 ...
 //BA.debugLineNum = 338;BA.debugLine="If Not(bordExists) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_bordexists)) { 
 //BA.debugLineNum = 339;BA.debugLine="AddUnkownIp(\"\", name)";
_addunkownip("",_name);
...
int _i = 0;
 //BA.debugLineNum = 379;BA.debugLine="Sub CheckIpInClv(bord As bordStatus)";
 //BA.debugLineNum = 380;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 383;BA.debugLine="For i = 0 To clvServer.GetSize-1";
{
final int step2 = 1;
final int limit2 = (int) (mostCurrent._clvserver._getsize()-1);
_i = (int) (0) ;
for (;_i <= limit2 ;_i = _i + step2 ) {
 //BA.debugLineNum = 384;BA.debugLine="p = clvServer.GetPanel(i)";
_p.setObject((android.view.ViewGroup)(mostCurrent._clvserver._getpanel(_i).getObject()));
 //BA.debugLineNum = 385;BA.debugLine="If p.Tag = bord.name Then";
if ((_p.getTag()).equals((Object)(_bord.name /*String*/ ))) { 
 //BA.debugLineNum = 392;BA.debugLine="baseFile.SetPanelLabelItemText(p, \"lblLastCheck";
_basefile._setpanellabelitemtext /*String*/ (_p,"lblLastCheck",("Laatste controle "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("time",(Object)(anywheresoftware.b4a.keywords.Common.DateTime.getNow()))+""));
 //BA.debugLineNum = 393;BA.debugLine="baseFile.SetBordDiedByName(bord.name, clvServer";
_basefile._setborddiedbyname /*String*/ (_bord.name /*String*/ ,mostCurrent._clvserver,_bord.alive /*boolean*/ );
 };
 }
};
 //BA.debugLineNum = 412;BA.debugLine="pnlNobords.SetVisibleAnimated(1000, False)";
mostCurrent._pnlnobords.SetVisibleAnimated((int) (1000),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 413;BA.debugLine="clvServer.Add(genUnitList(bord.name, bord.alive),";
...
nl.pdeg.bordondroid.main._bordstatus _bd = null;
 //BA.debugLineNum = 232;BA.debugLine="Sub CheckLastAliveTime";
 //BA.debugLineNum = 233;BA.debugLine="Dim currTime As Long = DateTime.Now";
_currtime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 234;BA.debugLine="Dim timeDiff As Long";
_timediff = 0L;
 //BA.debugLineNum = 235;BA.debugLine="Dim clvIndex, serverListIndex As Int";
_clvindex = 0;
_serverlistindex = 0;
 //BA.debugLineNum = 238;BA.debugLine="If lblLastCheck.IsInitialized = False Then";
if (mostCurrent._lbllastcheck.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 239;BA.debugLine="lblNoBord.Visible = False";
mostCurrent._lblnobord.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 240;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 243;BA.debugLine="lblLastCheck.Text = $\"Laatste controle $Time{Date";
mostCurrent._lbllastcheck.setText(BA.ObjectToCharSequence(("Laatste controle "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("time",(Object)(anywheresoftware.b4a.keywords.Common.DateTime.getNow()))+"")));
 //BA.debugLineNum = 245;BA.debugLine="For Each bd As bordStatus In Starter.serverList";
{
final anywheresoftware.b4a.BA.IterableList group9 = mostCurrent._starter._serverlist /*anywheresoftware.b4a.objects.collections.List*/ ;
final int groupLen9 = group9.getSize()
;int index9 = 0;
...
_bd = (nl.pdeg.bordondroid.main._bordstatus)(group9.Get(index9));
 //BA.debugLineNum = 246;BA.debugLine="timeDiff = currTime-bd.timeStamp";
_timediff = (long) (_currtime-_bd.timeStamp /*long*/ );
 //BA.debugLineNum = 248;BA.debugLine="If timeDiff >= Starter.serverDiedRemove Then";
if (_timediff>=mostCurrent._starter._serverdiedremove /*long*/ ) { 
 //BA.debugLineNum = 249;BA.debugLine="clvIndex = baseFile.GetPanelIndexFromBordName(b";
_clvindex = _basefile._getpanelindexfrombordname /*int*/ (_bd.name /*String*/ ,mostCurrent._clvserver);
 //BA.debugLineNum = 250;BA.debugLine="serverListIndex = baseFile.GetServerlistIndexFr";
_serverlistindex = _basefile._getserverlistindexfromname /*int*/ (_bd.name /*String*/ );
 //BA.debugLineNum = 251;BA.debugLine="If clvIndex <> -1 Then";
if (_clvindex!=-1) { 
 //BA.debugLineNum = 252;BA.debugLine="clvServer.RemoveAt(clvIndex)";
mostCurrent._clvserver._removeat(_clvindex);
 };
 //BA.debugLineNum = 254;BA.debugLine="If serverListIndex <> -1 Then";
if (_serverlistindex!=-1) { 
 //BA.debugLineNum = 255;BA.debugLine="Starter.serverList.RemoveAt(serverListIndex)";
...
if (true) return "";
 ...
 //BA.debugLineNum = 260;BA.debugLine="BordDiedProgress.Show";
mostCurrent._borddiedprogress._show /*String*/ ();
 //BA.debugLineNum = 261;BA.debugLine="If timeDiff >= Starter.serverDied Then";
if (_timediff>=mostCurrent._starter._serverdied /*long*/ ) { 
 //BA.debugLineNum = 262;BA.debugLine="bd.alive = False";
_bd.alive /*boolean*/  = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 263;BA.debugLine="baseFile.SetBordDiedByName(bd.name, clvServer,";
_basefile._setborddiedbyname /*String*/ (_bd.name /*String*/ ,mostCurrent._clvserver,_bd.alive /*boolean*/ );
 }else {
 //BA.debugLineNum = 265;BA.debugLine="baseFile.SetBordDiedByName(bd.name, clvServer,";
_basefile._setborddiedbyname /*String*/ (_bd.name /*String*/ ,mostCurrent._clvserver,_bd.alive /*boolean*/ );
 };
 }
};
...
//C
this.state = 1;
 //BA.debugLineNum = 197;BA.debugLine="Dim p As Panel = clvServer.GetPanel(Index)";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
_p.setObject((android.view.ViewGroup)(parent.mostCurrent._clvserver._getpanel(_index).getObject()));
 //BA.debugLineNum = 198;BA.debugLine="Dim unit As String";
_unit = "";
 //BA.debugLineNum = 200;BA.debugLine="unit = baseFile.GetSelectedLabelTagFromPanel(p, \"";
_unit = parent._basefile._getselectedlabeltagfrompanel /*String*/ (_p,"name");
 //BA.debugLineNum = 201;BA.debugLine="If baseFile.GetBordAlive(unit) = False Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 202;BA.debugLine="baseFile.ShowCustomToast($\"Bord niet gevonden, c";
...
this.state = -1;
;
 //BA.debugLineNum = 206;BA.debugLine="Starter.DiscoveredServer = unit";
parent.mostCurrent._starter._discoveredserver /*String*/  = _unit;
 //BA.debugLineNum = 207;BA.debugLine="CallSub2(Starter, \"SetLastWill\", \"recvdied\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(parent.mostCurrent._starter.getObject()),"SetLastWill",(Object)("recvdied"));
 //BA.debugLineNum = 208;BA.debugLine="CallSub2(Starter, \"SetUnit\", PrepTopicName(unit).";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(parent.mostCurrent._starter.getObject()),"SetUnit",(Object)(_preptopicname(_unit).toLowerCase()));
 //BA.debugLineNum = 210;BA.debugLine="DisconnectMqtt";
_disconnectmqtt();
 //BA.debugLineNum = 211;BA.debugLine="Sleep(100)";
anywheresoftware.b4a.keywords.Common.Sleep(mostCurrent.activityBA,this,(int) (100));
this.state = 5;
return;
case 5:
...
this.state = -1;
;
 //BA.debugLineNum = 212;BA.debugLine="StartActivity(ServerBoard)";
...
public static String  _connectionerror() throws Exception{
 //BA.debugLineNum = 526;BA.debugLine="Sub ConnectionError";
 //BA.debugLineNum = 527;BA.debugLine="baseFile.ShowCustomToast(\"MQTT Fout\", True, Color";
...
public static String  _deletedlocationactive() throws Exception{
 //BA.debugLineNum = 516;BA.debugLine="Sub DeletedLocationActive";
 //BA.debugLineNum = 517;BA.debugLine="mqttBase.Disconnect";
_mqttbase._disconnect /*String*/ ();
 //BA.debugLineNum = 518;BA.debugLine="clvServer.Clear";
mostCurrent._clvserver._clear();
 //BA.debugLineNum = 519;BA.debugLine="getBaseList";
_getbaselist();
 //BA.debugLineNum = 520;BA.debugLine="End Sub";
return "";
}
public static String  _disconnectmqtt() throws Exception{
 //BA.debugLineNum = 292;BA.debugLine="Sub DisconnectMqtt";
 //BA.debugLineNum = 293;BA.debugLine="If mqttBase.connected Then";
if (_mqttbase._connected /*boolean*/ ) { 
 //BA.debugLineNum = 294;BA.debugLine="mqttBase.Disconnect";
_mqttbase._disconnect /*String*/ ();
 };
 //BA.debugLineNum = 296;BA.debugLine="If CheckClientConnected Then";
if (_checkclientconnected()) { 
 //BA.debugLineNum = 297;BA.debugLine="mqttBase.Disconnect";
_mqttbase._disconnect /*String*/ ();
 };
...
public static String  _edtfloatcode_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 508;BA.debugLine="Sub edtFloatCode_TextChanged (Old As String, New A";
 //BA.debugLineNum = 509;BA.debugLine="If New.Length > 0 Then";
if (_new.length()>0) { 
 //BA.debugLineNum = 510;BA.debugLine="btnOk.Enabled = True";
mostCurrent._btnok.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 512;BA.debugLine="btnOk.Enabled = False";
...
public static String  _edtfloatdescription_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 504;BA.debugLine="Sub edtFloatDescription_TextChanged (Old As String";
...
public static String  _edtlocationcode_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 480;BA.debugLine="Sub edtLocationCode_TextChanged (Old As String, Ne";
 //BA.debugLineNum = 481;BA.debugLine="If New.Length > 0 Then";
if (_new.length()>0) { 
 //BA.debugLineNum = 482;BA.debugLine="btnOk.Enabled = True";
mostCurrent._btnok.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 484;BA.debugLine="btnOk.Enabled = False";
mostCurrent._btnok.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 };
...
anywheresoftware.b4a.objects.PanelWrapper _p = null;
 //BA.debugLineNum = 302;BA.debugLine="Sub genUnitList(name As String, alive As Boolean)";
 //BA.debugLineNum = 303;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 304;BA.debugLine="p.Initialize(Me)";
_p.Initialize(mostCurrent.activityBA,BA.ObjectToString(main.getObject()));
 //BA.debugLineNum = 305;BA.debugLine="p.SetLayout(0dip, 0dip, clvServer.AsView.Width, 9";
_p.SetLayout(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),mostCurrent._clvserver._asview().getWidth(),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (95)));
 //BA.debugLineNum = 306;BA.debugLine="p.LoadLayout(\"clvBorden\")";
_p.LoadLayout("clvBorden",mostCurrent.activityBA);
 //BA.debugLineNum = 307;BA.debugLine="p.Tag = name";
_p.setTag((Object)(_name));
 //BA.debugLineNum = 309;BA.debugLine="lblBordName.Text = name.Trim";
mostCurrent._lblbordname.setText(BA.ObjectToCharSequence(_name.trim()));
 //BA.debugLineNum = 310;BA.debugLine="lblLastCheck.Text = $\"Laatste controle $Time{Date";
mostCurrent._lbllastcheck.setText(BA.ObjectToCharSequence(("Laatste controle "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("time",(Object)(anywheresoftware.b4a.keywords.Common.DateTime.getNow()))+"")));
 //BA.debugLineNum = 311;BA.debugLine="BordDiedProgress.Show";
mostCurrent._borddiedprogress._show /*String*/ ();
 //BA.debugLineNum = 312;BA.debugLine="If Not(alive) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_alive)) { 
 //BA.debugLineNum = 313;BA.debugLine="lblViewBord.Enabled = False";
mostCurrent._lblviewbord.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 315;BA.debugLine="Return p";
if (true) return _p;
...
//C
this.state = 1;
 //BA.debugLineNum = 132;BA.debugLine="Dim listSize As Int = 0";
_listsize = (int) (0);
 //BA.debugLineNum = 134;BA.debugLine="baseList.Initialize";
parent._baselist.Initialize();
 //BA.debugLineNum = 135;BA.debugLine="baseList = baseFile.GetBase";
parent._baselist = parent._basefile._getbase /*anywheresoftware.b4a.objects.collections.List*/ ();
 //BA.debugLineNum = 137;BA.debugLine="If CallSub(baseFile, \"CheckBaseListExists\") = Fal";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 138;BA.debugLine="pnlLocationCOde.Visible = True";
...
if (true) return ;
 if (true) break;
;
 //BA.debugLineNum = 142;BA.debugLine="If baseList.IsInitialized Then";
...
//C
this.state = 7;
 //BA.debugLineNum = 143;BA.debugLine="listSize = baseList.Size";
_listsize = parent._baselist.getSize();
 if (true) break;
;
 //BA.debugLineNum = 145;BA.debugLine="If listSize > 1 Then";
...
//C
this.state = 12;
 //BA.debugLineNum = 147;BA.debugLine="pnlLocationList.SetVisibleAnimated(500, True)";
parent.mostCurrent._pnllocationlist.SetVisibleAnimated((int) (500),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 148;BA.debugLine="Sleep(200)";
...
//C
this.state = 12;
 //BA.debugLineNum = 150;BA.debugLine="pnlLocationList.SetVisibleAnimated(500, False)";
...
this.state = 13;
;
 //BA.debugLineNum = 154;BA.debugLine="lblNoBord.Text = \"Wachten op borden...\"";
parent.mostCurrent._lblnobord.setText(BA.ObjectToCharSequence("Wachten op borden..."));
 //BA.debugLineNum = 156;BA.debugLine="If baseList.IsInitialized = False Then";
if (true) break;
...
//C
this.state = 20;
 //BA.debugLineNum = 157;BA.debugLine="pnlLocationCOde.Visible = True";
parent.mostCurrent._pnllocationcode.setVisible(anywheresoftware.b4a.keywords.Common.True);
 if (true) break;
...
//C
this.state = 20;
 //BA.debugLineNum = 159;BA.debugLine="Dim loc As locationBord";
_loc = new nl.pdeg.bordondroid.main._locationbord();
 //BA.debugLineNum = 160;BA.debugLine="loc.Initialize";
_loc.Initialize();
 //BA.debugLineNum = 161;BA.debugLine="loc = baseList.Get(0)";
_loc = (nl.pdeg.bordondroid.main._locationbord)(parent._baselist.Get((int) (0)));
 //BA.debugLineNum = 162;BA.debugLine="Starter.selectedLocationCode = loc.code";
parent.mostCurrent._starter._selectedlocationcode /*String*/  = _loc.code /*String*/ ;
 //BA.debugLineNum = 163;BA.debugLine="Starter.selectedLocationDescription = loc.descri";
parent.mostCurrent._starter._selectedlocationdescription /*String*/  = _loc.description /*String*/ ;
 //BA.debugLineNum = 164;BA.debugLine="lblCurrLocation.Text = loc.description";
parent.mostCurrent._lblcurrlocation.setText(BA.ObjectToCharSequence(_loc.description /*String*/ ));
 //BA.debugLineNum = 165;BA.debugLine="InitConnection";
_initconnection();
 if (true) break;
...
//C
this.state = 20;
 //BA.debugLineNum = 167;BA.debugLine="StartActivity(SelectLocation)";
...
mostCurrent._lblbordname = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Private lblViewBord As Label";
...
mostCurrent._b4xloadingindicator2 = new nl.pdeg.bordondroid.b4xloadingindicator();
 //BA.debugLineNum = 51;BA.debugLine="Private BordDiedProgress As B4XLoadingIndicator";
...
//C
this.state = 1;
 //BA.debugLineNum = 183;BA.debugLine="If mqttBase.connected Then mqttBase.Disconnect";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 184;BA.debugLine="Starter.serverList.Initialize";
parent.mostCurrent._starter._serverlist /*anywheresoftware.b4a.objects.collections.List*/ .Initialize();
 //BA.debugLineNum = 185;BA.debugLine="clvServer.Clear";
parent.mostCurrent._clvserver._clear();
 //BA.debugLineNum = 186;BA.debugLine="lblCurrLocation.Text = Starter.selectedLocationDe";
parent.mostCurrent._lblcurrlocation.setText(BA.ObjectToCharSequence(parent.mostCurrent._starter._selectedlocationdescription /*String*/ ));
 //BA.debugLineNum = 187;BA.debugLine="CallSub2(Starter, \"SetLastWill\", \"bordpubdied\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(parent.mostCurrent._starter.getObject()),"SetLastWill",(Object)("bordpubdied"));
 //BA.debugLineNum = 188;BA.debugLine="CallSub2(Starter, \"SetSubBase\", Starter.selectedL";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(parent.mostCurrent._starter.getObject()),"SetSubBase",(Object)(parent.mostCurrent._starter._selectedlocationcode /*String*/ ));
 //BA.debugLineNum = 189;BA.debugLine="CallSub2(Starter, \"SetSubString2\", \"/pubbord\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(parent.mostCurrent._starter.getObject()),"SetSubString2",(Object)("/pubbord"));
 //BA.debugLineNum = 190;BA.debugLine="CallSub2(Starter, \"SetUnsubscribeString2\", \"\")";
...
this.state = -1;
;
 //BA.debugLineNum = 192;BA.debugLine="StartConnection";
_startconnection();
...
anywheresoftware.b4a.objects.PanelWrapper _p = null;
 //BA.debugLineNum = 416;BA.debugLine="Sub lblViewBord_Click";
 //BA.debugLineNum = 417;BA.debugLine="Dim v As View = Sender";
_v = new anywheresoftware.b4a.objects.ConcreteViewWrapper();
_v.setObject((android.view.View)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 418;BA.debugLine="Dim p As Panel = v.Parent";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
_p.setObject((android.view.ViewGroup)(_v.getParent()));
 //BA.debugLineNum = 420;BA.debugLine="clvServer_ItemClick (clvServer.GetItemFromView(p)";
...
public static String  _pnllocation_click() throws Exception{
 //BA.debugLineNum = 488;BA.debugLine="Sub pnlLocation_Click";
 //BA.debugLineNum = 490;BA.debugLine="If CheckClientConnected Then";
if (_checkclientconnected()) { 
 //BA.debugLineNum = 491;BA.debugLine="mqttBase.Disconnect";
_mqttbase._disconnect /*String*/ ();
 };
 //BA.debugLineNum = 493;BA.debugLine="StartActivity(locations)";
...
public static String  _pnllocationlist_click() throws Exception{
 //BA.debugLineNum = 500;BA.debugLine="Sub pnlLocationList_Click";
 //BA.debugLineNum = 501;BA.debugLine="StartActivity(SelectLocation)";
...
public static String  _preptopicname(String _bord) throws Exception{
 //BA.debugLineNum = 423;BA.debugLine="Private Sub PrepTopicName(bord As String) As Strin";
 //BA.debugLineNum = 424;BA.debugLine="Return bord.Replace(\" \", \"\")";
...
public static String  _reconnecttolocation() throws Exception{
 //BA.debugLineNum = 171;BA.debugLine="Sub ReconnectToLocation";
 //BA.debugLineNum = 172;BA.debugLine="mqttBase.Initialize";
_mqttbase._initialize /*String*/ (processBA);
 //BA.debugLineNum = 173;BA.debugLine="CallSub2(Starter, \"SetLastWill\", \"bordpubdied\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._starter.getObject()),"SetLastWill",(Object)("bordpubdied"));
 //BA.debugLineNum = 174;BA.debugLine="CallSub2(Starter, \"SetSubBase\", Starter.selectedL";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._starter.getObject()),"SetSubBase",(Object)(mostCurrent._starter._selectedlocationcode /*String*/ ));
 //BA.debugLineNum = 175;BA.debugLine="CallSub2(Starter, \"SetSubString2\", \"/pubbord\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._starter.getObject()),"SetSubString2",(Object)("/pubbord"));
 //BA.debugLineNum = 176;BA.debugLine="CallSub2(Starter, \"SetUnsubscribeString2\", \"\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._starter.getObject()),"SetUnsubscribeString2",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="mqttBase.Connect";
_mqttbase._connect /*String*/ ();
 //BA.debugLineNum = 178;BA.debugLine="End Sub";
return "";
}
public static String  _resumeconnection(boolean _resume) throws Exception{
 //BA.debugLineNum = 276;BA.debugLine="Sub ResumeConnection(resume As Boolean)";
 //BA.debugLineNum = 277;BA.debugLine="tmrBordLastAlive.Enabled = resume";
_tmrbordlastalive.setEnabled(_resume);
 //BA.debugLineNum = 278;BA.debugLine="End Sub";
return "";
}
public static String  _setbordlastalivetimer() throws Exception{
 //BA.debugLineNum = 104;BA.debugLine="Sub setBordLastAliveTimer";
 //BA.debugLineNum = 105;BA.debugLine="tmrBordLastAlive.Enabled = True";
...
public static String  _shownotconnectedtobroker() throws Exception{
 //BA.debugLineNum = 271;BA.debugLine="Sub ShowNotConnectedToBroker";
 //BA.debugLineNum = 272;BA.debugLine="lblNoBord.Text = \"Verbinding borden verbroken\"";
mostCurrent._lblnobord.setText(BA.ObjectToCharSequence("Verbinding borden verbroken"));
 //BA.debugLineNum = 273;BA.debugLine="pnlNobords.SetVisibleAnimated(1000, True)";
...
public static String  _showselectlocationbutton() throws Exception{
 //BA.debugLineNum = 522;BA.debugLine="Sub ShowSelectLocationButton";
 //BA.debugLineNum = 523;BA.debugLine="pnlLocationList.Visible = baseFile.GetBase.Size >";
...
//C
this.state = -1;
 //BA.debugLineNum = 110;BA.debugLine="pnlLocationCOde.Visible = False";
parent.mostCurrent._pnllocationcode.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 111;BA.debugLine="B4XLoadingIndicator1.Show";
parent.mostCurrent._b4xloadingindicator1._show /*String*/ ();
 //BA.debugLineNum = 112;BA.debugLine="B4XLoadingIndicator2.Show";
parent.mostCurrent._b4xloadingindicator2._show /*String*/ ();
 //BA.debugLineNum = 113;BA.debugLine="Sleep(10)";
...
this.state = -1;
;
 //BA.debugLineNum = 114;BA.debugLine="pnlNobords.Visible = True";
parent.mostCurrent._pnlnobords.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 115;BA.debugLine="clvServer.Clear";
parent.mostCurrent._clvserver._clear();
 //BA.debugLineNum = 116;BA.debugLine="mqttBase.Initialize";
parent._mqttbase._initialize /*String*/ (processBA);
 //BA.debugLineNum = 117;BA.debugLine="mqttBase.Connect";
parent._mqttbase._connect /*String*/ ();
 //BA.debugLineNum = 119;BA.debugLine="baseFile.GetBase";
parent._basefile._getbase /*anywheresoftware.b4a.objects.collections.List*/ ();
 //BA.debugLineNum = 121;BA.debugLine="tmrBordLastAlive.Initialize(\"tmrBordAlive\", 10000";
parent._tmrbordlastalive.Initialize(processBA,"tmrBordAlive",(long) (10000));
 //BA.debugLineNum = 122;BA.debugLine="tmrBordLastAlive.Enabled = True";
parent._tmrbordlastalive.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 123;BA.debugLine="connectTime = DateTime.Now";
...
public static String  _tmrbordalive_tick() throws Exception{
 //BA.debugLineNum = 215;BA.debugLine="Sub tmrBordAlive_Tick";
 //BA.debugLineNum = 216;BA.debugLine="If Not(checkConnectTime) Then Return";
if (anywheresoftware.b4a.keywords.Common.Not(_checkconnecttime())) { 
if (true) return "";};
 //BA.debugLineNum = 217;BA.debugLine="CheckLastAliveTime";
_checklastalivetime();
