...
mostCurrent._activity.LoadLayout("main",mostCurrent.activityBA);
 //BA.debugLineNum = 39;BA.debugLine="lblVersion.Text = \"v\"&Application.VersionName";
mostCurrent._lblversion.setText(BA.ObjectToCharSequence("v"+anywheresoftware.b4a.keywords.Common.Application.getVersionName()));
 //BA.debugLineNum = 40;BA.debugLine="clvServer.Clear";
mostCurrent._clvserver._clear();
 //BA.debugLineNum = 41;BA.debugLine="mqttGetData.Initialize";
_mqttgetdata._initialize /*String*/ (processBA);
 //BA.debugLineNum = 42;BA.debugLine="mqttGetBord.Initialize";
_mqttgetbord._initialize /*String*/ (processBA);
 //BA.debugLineNum = 43;BA.debugLine="mqttGetBord.Connect";
_mqttgetbord._connect /*String*/ ();
 //BA.debugLineNum = 45;BA.debugLine="tmrBordLastAlive.Initialize(\"tmrBordAlive\", 10000";
_tmrbordlastalive.Initialize(processBA,"tmrBordAlive",(long) (10000));
 //BA.debugLineNum = 46;BA.debugLine="tmrBordLastAlive.Enabled = True";
_tmrbordlastalive.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 47;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 68;BA.debugLine="Private Sub Activity_KeyPress(KeyCode As Int) As B";
 //BA.debugLineNum = 69;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 70;BA.debugLine="tmrBordLastAlive.Enabled = False";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 65;BA.debugLine="DisconnectMqtt";
_disconnectmqtt();
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 59;BA.debugLine="If Starter.mqttGetBordsActive Then";
if (mostCurrent._starter._mqttgetbordsactive /*boolean*/ ) { 
 //BA.debugLineNum = 60;BA.debugLine="mqttGetBord.Connect";
_mqttgetbord._connect /*String*/ ();
 };
...
//C
this.state = 1;
 //BA.debugLineNum = 146;BA.debugLine="Dim bordStatus As bordStatus";
_bordstatus = new nl.pdeg.bordondroid.main._bordstatus();
 //BA.debugLineNum = 147;BA.debugLine="bordStatus.Initialize";
_bordstatus.Initialize();
 //BA.debugLineNum = 148;BA.debugLine="bordStatus.ip = ip";
_bordstatus.ip /*String*/  = _ip;
 //BA.debugLineNum = 149;BA.debugLine="bordStatus.name = name";
_bordstatus.name /*String*/  = _name;
 //BA.debugLineNum = 150;BA.debugLine="bordStatus.timeStamp = DateTime.Now";
_bordstatus.timeStamp /*long*/  = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 151;BA.debugLine="bordStatus.alive = True";
_bordstatus.alive /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 152;BA.debugLine="Starter.serverList.Add(bordStatus)";
parent.mostCurrent._starter._serverlist /*anywheresoftware.b4a.objects.collections.List*/ .Add((Object)(_bordstatus));
 //BA.debugLineNum = 153;BA.debugLine="CheckIpInClv(bordStatus)";
_checkipinclv(_bordstatus);
 //BA.debugLineNum = 155;BA.debugLine="If clvServer.GetSize > 0 Then";
if (true) break;
...
//C
this.state = 6;
 //BA.debugLineNum = 156;BA.debugLine="pnlNobords.SetVisibleAnimated(1000, False)";
...
//C
this.state = 6;
 //BA.debugLineNum = 158;BA.debugLine="pnlNobords.SetVisibleAnimated(1000, True)";
...
this.state = -1;
;
 //BA.debugLineNum = 160;BA.debugLine="Sleep(1000)";
...
nl.pdeg.bordondroid.main._bordstatus _lst = null;
 //BA.debugLineNum = 101;BA.debugLine="Sub CheckIpExits(bord As String)";
 //BA.debugLineNum = 103;BA.debugLine="Dim ipFound As Boolean = False";
_ipfound = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 104;BA.debugLine="Dim name As String = \"\"";
_name = "";
 //BA.debugLineNum = 106;BA.debugLine="If bord.Length = 0 Then Return";
if (_bord.length()==0) { 
if (true) return "";};
 //BA.debugLineNum = 108;BA.debugLine="name = bord";
_name = _bord;
 //BA.debugLineNum = 110;BA.debugLine="If Starter.serverList.Size = 0 Then";
if (mostCurrent._starter._serverlist /*anywheresoftware.b4a.objects.collections.List*/ .getSize()==0) { 
 //BA.debugLineNum = 111;BA.debugLine="AddUnkownIp(\"\", name)";
_addunkownip("",_name);
 //BA.debugLineNum = 112;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 115;BA.debugLine="For Each lst As bordStatus In Starter.serverList";
{
...
_lst = (nl.pdeg.bordondroid.main._bordstatus)(group9.Get(index9));
 //BA.debugLineNum = 116;BA.debugLine="If lst.name = name Then";
if ((_lst.name /*String*/ ).equals(_name)) { 
 //BA.debugLineNum = 117;BA.debugLine="ipFound = True";
_ipfound = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 118;BA.debugLine="lst.timeStamp = DateTime.Now";
_lst.timeStamp /*long*/  = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 119;BA.debugLine="lst.alive = True";
_lst.alive /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 };
 }
};
 //BA.debugLineNum = 123;BA.debugLine="ServerAlive";
_serveralive();
 //BA.debugLineNum = 125;BA.debugLine="If Not(ipFound) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_ipfound)) { 
 //BA.debugLineNum = 126;BA.debugLine="AddUnkownIp(\"\", name)";
_addunkownip("",_name);
...
anywheresoftware.b4a.objects.ConcreteViewWrapper _v = null;
 //BA.debugLineNum = 164;BA.debugLine="Sub CheckIpInClv(bord As bordStatus)";
 //BA.debugLineNum = 165;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 166;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 168;BA.debugLine="For i = 0 To clvServer.GetSize-1";
{
final int step3 = 1;
final int limit3 = (int) (mostCurrent._clvserver._getsize()-1);
_i = (int) (0) ;
for (;_i <= limit3 ;_i = _i + step3 ) {
 //BA.debugLineNum = 169;BA.debugLine="p = clvServer.GetPanel(i)";
_p = mostCurrent._clvserver._getpanel(_i);
 //BA.debugLineNum = 170;BA.debugLine="If p.Tag = bord.name Then";
...
_v.setObject((android.view.View)(group6.Get(index6)));
 //BA.debugLineNum = 172;BA.debugLine="If v.Tag = \"lblLastCheck\" Then";
...
_lbl.setObject((android.widget.TextView)(_v.getObject()));
 //BA.debugLineNum = 174;BA.debugLine="lbl.Text = $\"Laatste controle $Time{DateTime.";
_lbl.setText(BA.ObjectToCharSequence(("Laatste controle "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("time",(Object)(anywheresoftware.b4a.keywords.Common.DateTime.getNow()))+"")));
 ...
 //BA.debugLineNum = 178;BA.debugLine="For Each v As View In p.GetAllViewsRecursive";
_v = new anywheresoftware.b4a.objects.ConcreteViewWrapper();
{
...
_v.setObject((android.view.View)(group12.Get(index12)));
 //BA.debugLineNum = 179;BA.debugLine="If v.Tag = \"viewbord\" Then";
if ((_v.getTag()).equals((Object)("viewbord"))) { 
 //BA.debugLineNum = 180;BA.debugLine="lbl = v";
_lbl.setObject((android.widget.TextView)(_v.getObject()));
 //BA.debugLineNum = 181;BA.debugLine="If bord.alive = False Then";
if (_bord.alive /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 182;BA.debugLine="lbl.Enabled = False";
_lbl.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 183;BA.debugLine="lbl.TextColor = Colors.Red";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 184;BA.debugLine="Starter.diedIndex = i";
mostCurrent._starter._diedindex /*int*/  = _i;
 }else {
 //BA.debugLineNum = 186;BA.debugLine="lbl.Enabled = True";
_lbl.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 187;BA.debugLine="lbl.TextColor = 0xFF027F00";
...
if (true) return "";
 ...
 //BA.debugLineNum = 196;BA.debugLine="pnlNobords.SetVisibleAnimated(1000, False)";
mostCurrent._pnlnobords.SetVisibleAnimated((int) (1000),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 197;BA.debugLine="clvServer.Add(genUnitList(bord.name, bord.alive),";
mostCurrent._clvserver._add(_genunitlist(_bord.name /*String*/ ,_bord.alive /*boolean*/ ),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100)),(Object)(""));
...
//C
this.state = 1;
 //BA.debugLineNum = 228;BA.debugLine="Dim p As Panel = clvServer.GetPanel(Index)";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
_p = parent.mostCurrent._clvserver._getpanel(_index);
 //BA.debugLineNum = 229;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 232;BA.debugLine="For Each c As View In p.GetAllViewsRecursive";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 233;BA.debugLine="If c.Tag = \"name\" Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 234;BA.debugLine="lbl = c";
_lbl.setObject((android.widget.TextView)(_c.getObject()));
 //BA.debugLineNum = 235;BA.debugLine="Starter.selectedBordName = PrepTopicName(lbl.Te";
parent.mostCurrent._starter._selectedbordname /*String*/  = _preptopicname(_lbl.getText());
 //BA.debugLineNum = 236;BA.debugLine="Starter.DiscoveredServer = lbl.Text";
parent.mostCurrent._starter._discoveredserver /*String*/  = _lbl.getText();
 //BA.debugLineNum = 237;BA.debugLine="Exit";
this.state = 8;
if (true) break;
 if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 241;BA.debugLine="DisconnectMqtt";
_disconnectmqtt();
 //BA.debugLineNum = 242;BA.debugLine="Sleep(100)";
...
this.state = -1;
;
 //BA.debugLineNum = 244;BA.debugLine="StartActivity(ServerBoard)";
...
public static String  _disconnectmqtt() throws Exception{
 //BA.debugLineNum = 79;BA.debugLine="Sub DisconnectMqtt";
 //BA.debugLineNum = 80;BA.debugLine="If mqttGetBord.Connected Then";
if (_mqttgetbord._connected /*boolean*/ ) { 
 //BA.debugLineNum = 81;BA.debugLine="mqttGetBord.Disconnect";
...
anywheresoftware.b4a.objects.PanelWrapper _p = null;
 //BA.debugLineNum = 86;BA.debugLine="Sub genUnitList(name As String, alive As Boolean)";
 //BA.debugLineNum = 87;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 88;BA.debugLine="p.Initialize(Me)";
_p.Initialize(mostCurrent.activityBA,BA.ObjectToString(main.getObject()));
 //BA.debugLineNum = 89;BA.debugLine="p.SetLayout(0dip, 0dip, clvServer.AsView.Width, 1";
_p.SetLayout(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),mostCurrent._clvserver._asview().getWidth(),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)));
 //BA.debugLineNum = 90;BA.debugLine="p.LoadLayout(\"clvBorden\")";
_p.LoadLayout("clvBorden",mostCurrent.activityBA);
 //BA.debugLineNum = 91;BA.debugLine="p.Tag = name";
_p.setTag((Object)(_name));
 //BA.debugLineNum = 93;BA.debugLine="lblBordName.Text = name.Trim";
mostCurrent._lblbordname.setText(BA.ObjectToCharSequence(_name.trim()));
 //BA.debugLineNum = 94;BA.debugLine="lblLastCheck.Text = $\"Laatste controle $Time{Date";
mostCurrent._lbllastcheck.setText(BA.ObjectToCharSequence(("Laatste controle "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("time",(Object)(anywheresoftware.b4a.keywords.Common.DateTime.getNow()))+"")));
 //BA.debugLineNum = 95;BA.debugLine="If Not(alive) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_alive)) { 
 //BA.debugLineNum = 96;BA.debugLine="lblViewBord.Enabled = False";
...
//C
this.state = 4;
 //BA.debugLineNum = 207;BA.debugLine="If c.Tag = \"name\" Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 208;BA.debugLine="lbl = c";
_lbl.setObject((android.widget.TextView)(_c.getObject()));
 //BA.debugLineNum = 209;BA.debugLine="Starter.selectedBordName = PrepTopicName(lbl.Te";
parent.mostCurrent._starter._selectedbordname /*String*/  = _preptopicname(_lbl.getText());
 //BA.debugLineNum = 210;BA.debugLine="Starter.DiscoveredServer = lbl.Text";
parent.mostCurrent._starter._discoveredserver /*String*/  = _lbl.getText();
...
this.state = -1;
;
 //BA.debugLineNum = 215;BA.debugLine="DisconnectMqtt";
_disconnectmqtt();
 //BA.debugLineNum = 216;BA.debugLine="Sleep(100)";
anywheresoftware.b4a.keywords.Common.Sleep(mostCurrent.activityBA,this,(int) (100));
this.state = 11;
return;
case 11:
...
this.state = -1;
;
 //BA.debugLineNum = 218;BA.debugLine="StartActivity(ServerBoard)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(parent.mostCurrent._serverboard.getObject()));
...
public static String  _preptopicname(String _bord) throws Exception{
 //BA.debugLineNum = 221;BA.debugLine="Private Sub PrepTopicName(bord As String) As Strin";
 //BA.debugLineNum = 222;BA.debugLine="Log($\"SUBBORD : ${bord.Replace(\" \", \"\")}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("1917505",("SUBBORD : "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_bord.replace(" ","")))+""),0);
 //BA.debugLineNum = 223;BA.debugLine="Return bord.Replace(\" \", \"\")";
...
long _msnow = 0L;
nl.pdeg.bordondroid.main._bordstatus _lst = null;
 //BA.debugLineNum = 131;BA.debugLine="Sub ServerAlive";
 //BA.debugLineNum = 133;BA.debugLine="Dim msNow As Long = DateTime.Now";
_msnow = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 134;BA.debugLine="For Each lst As bordStatus In Starter.serverList";
{
...
_lst = (nl.pdeg.bordondroid.main._bordstatus)(group2.Get(index2));
 //BA.debugLineNum = 135;BA.debugLine="If(msNow - lst.timeStamp) > Starter.serverDied A";
if ((_msnow-_lst.timeStamp /*long*/ )>mostCurrent._starter._serverdied /*long*/  && _lst.alive /*boolean*/ ==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 136;BA.debugLine="lst.alive = False";
_lst.alive /*boolean*/  = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 137;BA.debugLine="CheckIpInClv(lst)";
_checkipinclv(_lst);
 //BA.debugLineNum = 138;BA.debugLine="Return";
if (true) return "";
 }else {
 //BA.debugLineNum = 140;BA.debugLine="CheckIpInClv(lst)";
_checkipinclv(_lst);
 };
 }
};
...
public static String  _tmrbordalive_tick() throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Sub tmrBordAlive_Tick";
 //BA.debugLineNum = 50;BA.debugLine="If Starter.diedIndex > -1 Then";
if (mostCurrent._starter._diedindex /*int*/ >-1) { 
 //BA.debugLineNum = 51;BA.debugLine="clvServer.RemoveAt(Starter.diedIndex)";
mostCurrent._clvserver._removeat(mostCurrent._starter._diedindex /*int*/ );
 //BA.debugLineNum = 52;BA.debugLine="Starter.serverList.RemoveAt(Starter.diedIndex)";
mostCurrent._starter._serverlist /*anywheresoftware.b4a.objects.collections.List*/ .RemoveAt(mostCurrent._starter._diedindex /*int*/ );
 //BA.debugLineNum = 53;BA.debugLine="Starter.diedIndex = -1";
mostCurrent._starter._diedindex /*int*/  = (int) (-1);
 };
 //BA.debugLineNum = 55;BA.debugLine="ServerAlive";
_serveralive();
