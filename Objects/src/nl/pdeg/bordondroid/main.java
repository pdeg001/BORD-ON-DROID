...
public static anywheresoftware.b4a.objects.Timer _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = null;
public static nl.pdeg.bordondroid.base _v5 = null;
public static anywheresoftware.b4a.objects.collections.List _vvvvvvv4 = null;
public static nl.pdeg.bordondroid.mqttconnector _vvvv7 = null;
public static boolean _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = false;
...
public anywheresoftware.b4a.objects.EditTextWrapper _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = null;
...
public static long _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = 0L;
...
mostCurrent._vvvvvvvv1._vvv6 /*String*/  = (""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.Application.getLabelName()))+" v"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.Application.getVersionName()))+"");
 //BA.debugLineNum = 64;BA.debugLine="lblVersion.Text = Starter.appVersion";
mostCurrent._lblversion.setText(BA.ObjectToCharSequence(mostCurrent._vvvvvvvv1._vvv6 /*String*/ ));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.setEnabled(anywheresoftware.b4a.keywords.Common.False);
...
mostCurrent._vvvvvvvv1._vvvv2 /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
...
if (mostCurrent._vvvvvvvv1._vvvv2 /*boolean*/ ) { 
...
mostCurrent._vvvvvvvv1._vvvv2 /*boolean*/  = anywheresoftware.b4a.keywords.Common.False;
 }else {
 };
 //BA.debugLineNum = 90;BA.debugLine="End Sub";
return "";
}
public static void  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(String _ip,String _name) throws Exception{
...
parent.mostCurrent._vvvvvvvv1._vv3 /*anywheresoftware.b4a.objects.collections.List*/ .Add((Object)(_bordstatus));
 //BA.debugLineNum = 358;BA.debugLine="CheckIpInClv(bordStatus)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(_bordstatus);
 //BA.debugLineNum = 359;BA.debugLine="baseFile.SetBordDiedByName(name, clvServer, True)";
parent._v5._vvvvvv6 /*String*/ (_name,parent.mostCurrent._clvserver,anywheresoftware.b4a.keywords.Common.True);
...
//if
this.state = 4;
if ((parent.mostCurrent._edtfloatcode._getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 /*String*/ ()).equals("")) { 
this.state = 3;
}if (true) break;
...
parent.mostCurrent._vvvvvvvv1._vvv5 /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 438;BA.debugLine="Starter.selectedLocationCode = edtFloatCode.Text";
parent.mostCurrent._vvvvvvvv1._vvv3 /*String*/  = parent.mostCurrent._edtfloatcode._getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 /*String*/ ();
 //BA.debugLineNum = 439;BA.debugLine="CallSub2(Starter, \"SetLastWill\", \"bordpubdied\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(parent.mostCurrent._vvvvvvvv1.getObject()),"SetLastWill",(Object)("bordpubdied"));
 //BA.debugLineNum = 440;BA.debugLine="CallSub2(Starter, \"SetSubBase\", Starter.selectedL";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(parent.mostCurrent._vvvvvvvv1.getObject()),"SetSubBase",(Object)(parent.mostCurrent._vvvvvvvv1._vvv3 /*String*/ ));
 //BA.debugLineNum = 441;BA.debugLine="CallSub2(Starter, \"SetSubString2\", \"/pubbord\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(parent.mostCurrent._vvvvvvvv1.getObject()),"SetSubString2",(Object)("/pubbord"));
 //BA.debugLineNum = 442;BA.debugLine="CallSub2(Starter, \"SetUnsubscribeString2\", \"\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(parent.mostCurrent._vvvvvvvv1.getObject()),"SetUnsubscribeString2",(Object)(""));
...
parent.mostCurrent._lblcurrlocation.setText(BA.ObjectToCharSequence(parent.mostCurrent._edtfloatdescription._getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 /*String*/ ()));
 //BA.debugLineNum = 455;BA.debugLine="Starter.selectedLocationDescription = edtFloatDe";
parent.mostCurrent._vvvvvvvv1._vvv4 /*String*/  = parent.mostCurrent._edtfloatdescription._getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 /*String*/ ();
 //BA.debugLineNum = 456;BA.debugLine="code = edtFloatCode.Text";
_code = parent.mostCurrent._edtfloatcode._getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 /*String*/ ();
...
//if
this.state = 15;
if ((parent.mostCurrent._edtfloatdescription._getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 /*String*/ ()).equals("")) { 
this.state = 12;
;}if (true) break;
...
//C
this.state = 15;
parent.mostCurrent._edtfloatdescription._setvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 /*String*/ ("Nieuwe locatie");
if (true) break;
...
_description = parent.mostCurrent._edtfloatdescription._getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 /*String*/ ();
...
parent._v5._vvvvvv5 /*String*/ (_code,_description,"1");
...
public static boolean  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5() throws Exception{
...
public static boolean  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6() throws Exception{
 //BA.debugLineNum = 218;BA.debugLine="Sub checkConnectTime As Boolean";
 //BA.debugLineNum = 219;BA.debugLine="If connectTime <> -1 Then";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7!=-1) { 
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = (long) (-1);
 //BA.debugLineNum = 318;BA.debugLine="If Starter.serverList.Size = 0 Then";
if (mostCurrent._vvvvvvvv1._vv3 /*anywheresoftware.b4a.objects.collections.List*/ .getSize()==0) { 
 //BA.debugLineNum = 319;BA.debugLine="AddUnkownIp(\"\", name)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3("",_name);
 //BA.debugLineNum = 320;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 323;BA.debugLine="For Each lst As bordStatus In Starter.serverList";
{
final anywheresoftware.b4a.BA.IterableList group9 = mostCurrent._vvvvvvvv1._vv3 /*anywheresoftware.b4a.objects.collections.List*/ ;
...
public static String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(nl.pdeg.bordondroid.main._bordstatus _bord) throws Exception{
...
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 374;BA.debugLine="Dim lbl As Label";
...
_v5._vvvvvv0 /*String*/ (_p,"lblLastCheck",("Laatste controle "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("time",(Object)(anywheresoftware.b4a.keywords.Common.DateTime.getNow()))+""));
 //BA.debugLineNum = 386;BA.debugLine="baseFile.SetBordDiedByName(bord.name, clvServer";
_v5._vvvvvv6 /*String*/ (_bord.name /*String*/ ,mostCurrent._clvserver,_bord.alive /*boolean*/ );
 };
 }
};
...
mostCurrent._clvserver._add((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0(_bord.name /*String*/ ,_bord.alive /*boolean*/ ).getObject())),(Object)(""));
...
{
final anywheresoftware.b4a.BA.IterableList group8 = mostCurrent._vvvvvvvv1._vv3 /*anywheresoftware.b4a.objects.collections.List*/ ;
...
if (_timediff>=mostCurrent._vvvvvvvv1._vv4 /*long*/ ) { 
...
_v5._vvvvvv6 /*String*/ (_bd.name /*String*/ ,mostCurrent._clvserver,_bd.alive /*boolean*/ );
 }else {
...
parent._v5._vvvvvvv2 /*String*/ ((Object)(("Bord niet gevonden, controleer of het bord \"online\" is")),anywheresoftware.b4a.keywords.Common.False,anywheresoftware.b4a.keywords.Common.Colors.Red);
...
parent.mostCurrent._vvvvvvvv1._vv2 /*String*/  = _unit;
 //BA.debugLineNum = 205;BA.debugLine="CallSub2(Starter, \"SetLastWill\", \"recvdied\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(parent.mostCurrent._vvvvvvvv1.getObject()),"SetLastWill",(Object)("recvdied"));
 //BA.debugLineNum = 206;BA.debugLine="CallSub2(Starter, \"SetUnit\", PrepTopicName(unit).";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(parent.mostCurrent._vvvvvvvv1.getObject()),"SetUnit",(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(_unit).toLowerCase()));
...
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(parent.mostCurrent._vvvvvvvv3.getObject()));
...
_v5._vvvvvvv2 /*String*/ ((Object)("MQTT Fout"),anywheresoftware.b4a.keywords.Common.True,anywheresoftware.b4a.keywords.Common.Colors.Red);
...
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5()) { 
...
public static anywheresoftware.b4a.objects.PanelWrapper  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0(String _name,boolean _alive) throws Exception{
anywheresoftware.b4a.objects.PanelWrapper _p = null;
...
parent._vvvvvvv4.Initialize();
 //BA.debugLineNum = 133;BA.debugLine="baseList = baseFile.GetBase";
parent._vvvvvvv4 = parent._v5._vvvv4 /*anywheresoftware.b4a.objects.collections.List*/ ();
...
//if
this.state = 7;
if (parent._vvvvvvv4.IsInitialized()) { 
this.state = 6;
}if (true) break;
...
_listsize = parent._vvvvvvv4.getSize();
 if (true) break;
;
...
//if
this.state = 20;
if (parent._vvvvvvv4.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
this.state = 15;
}else if(parent._vvvvvvv4.getSize()==1) { 
this.state = 17;
}else {
this.state = 19;
}if (true) break;
...
_loc = (nl.pdeg.bordondroid.main._locationbord)(parent._vvvvvvv4.Get((int) (0)));
 //BA.debugLineNum = 160;BA.debugLine="Starter.selectedLocationCode = loc.code";
parent.mostCurrent._vvvvvvvv1._vvv3 /*String*/  = _loc.code /*String*/ ;
 //BA.debugLineNum = 161;BA.debugLine="Starter.selectedLocationDescription = loc.descri";
parent.mostCurrent._vvvvvvvv1._vvv4 /*String*/  = _loc.description /*String*/ ;
...
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(parent.mostCurrent._vvvvvvvv2.getObject()));
 if (true) break;
...
mostCurrent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = new anywheresoftware.b4a.objects.EditTextWrapper();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = 0L;
...
parent.mostCurrent._vvvvvvvv1._vv3 /*anywheresoftware.b4a.objects.collections.List*/ .Initialize();
...
parent.mostCurrent._lblcurrlocation.setText(BA.ObjectToCharSequence(parent.mostCurrent._vvvvvvvv1._vvv4 /*String*/ ));
...
public static String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(String _bord) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = new anywheresoftware.b4a.objects.Timer();
...
_vvvvvvv4 = new anywheresoftware.b4a.objects.collections.List();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = false;
...
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._vvvvvvvv1.getObject()),"SetLastWill",(Object)("bordpubdied"));
 //BA.debugLineNum = 172;BA.debugLine="CallSub2(Starter, \"SetSubBase\", Starter.selectedL";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._vvvvvvvv1.getObject()),"SetSubBase",(Object)(mostCurrent._vvvvvvvv1._vvv3 /*String*/ ));
 //BA.debugLineNum = 173;BA.debugLine="CallSub2(Starter, \"SetSubString2\", \"/pubbord\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._vvvvvvvv1.getObject()),"SetSubString2",(Object)("/pubbord"));
 //BA.debugLineNum = 174;BA.debugLine="CallSub2(Starter, \"SetUnsubscribeString2\", \"\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._vvvvvvvv1.getObject()),"SetUnsubscribeString2",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="mqttBase.Connect";
_vvvv7._vvvvvvvv4 /*String*/ ();
 //BA.debugLineNum = 176;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(boolean _resume) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.setEnabled(_resume);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 105;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(long _firstmsgtime) throws Exception{
 //BA.debugLineNum = 125;BA.debugLine="Sub setConnectedTime(firstMsgTime As Long)";
 //BA.debugLineNum = 126;BA.debugLine="connectTime = firstMsgTime";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = _firstmsgtime;
...
public static String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2() throws Exception{
...
public static void  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5() throws Exception{
...
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.Initialize(processBA,"tmrBordAlive",(long) (10000));
 //BA.debugLineNum = 120;BA.debugLine="tmrBordLastAlive.Enabled = True";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 121;BA.debugLine="connectTime = DateTime.Now";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
...
if (anywheresoftware.b4a.keywords.Common.Not(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6())) { 
if (true) return "";};
