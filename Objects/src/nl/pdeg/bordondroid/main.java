...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 83;BA.debugLine="Starter.mainPaused = True";
mostCurrent._starter._mainpaused /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 84;BA.debugLine="ResumeConnection(False)";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 69;BA.debugLine="ShowSelectLocationButton";
_showselectlocationbutton();
 //BA.debugLineNum = 70;BA.debugLine="If Starter.mainPaused Then";
if (mostCurrent._starter._mainpaused /*boolean*/ ) { 
 //BA.debugLineNum = 71;BA.debugLine="ResumeConnection(True)";
_resumeconnection(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 72;BA.debugLine="Starter.mainPaused = False";
mostCurrent._starter._mainpaused /*boolean*/  = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 73;BA.debugLine="Starter.pingMqtt = True";
mostCurrent._starter._pingmqtt /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 75;BA.debugLine="mqttBase.Connect";
...
//C
this.state = 1;
 //BA.debugLineNum = 355;BA.debugLine="Dim bordStatus As bordStatus";
_bordstatus = new nl.pdeg.bordondroid.main._bordstatus();
 //BA.debugLineNum = 356;BA.debugLine="bordStatus.Initialize";
_bordstatus.Initialize();
 //BA.debugLineNum = 357;BA.debugLine="bordStatus.ip = ip";
_bordstatus.ip /*String*/  = _ip;
 //BA.debugLineNum = 358;BA.debugLine="bordStatus.name = name";
_bordstatus.name /*String*/  = _name;
 //BA.debugLineNum = 359;BA.debugLine="bordStatus.timeStamp = DateTime.Now";
_bordstatus.timeStamp /*long*/  = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 360;BA.debugLine="bordStatus.alive = True";
_bordstatus.alive /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 362;BA.debugLine="Starter.serverList.Add(bordStatus)";
parent.mostCurrent._starter._serverlist /*anywheresoftware.b4a.objects.collections.List*/ .Add((Object)(_bordstatus));
 //BA.debugLineNum = 363;BA.debugLine="CheckIpInClv(bordStatus, players)";
_checkipinclv(_bordstatus,_players);
 //BA.debugLineNum = 364;BA.debugLine="baseFile.SetBordDiedByName(name, clvServer, True)";
parent._basefile._setborddiedbyname /*String*/ (_name,parent.mostCurrent._clvserver,anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 366;BA.debugLine="If clvServer.GetSize > 0 Then";
if (true) break;
...
//C
this.state = 6;
 //BA.debugLineNum = 367;BA.debugLine="pnlNobords.SetVisibleAnimated(500, False)";
...
//C
this.state = 6;
 //BA.debugLineNum = 369;BA.debugLine="pnlNobords.SetVisibleAnimated(500, True)";
...
this.state = -1;
;
 //BA.debugLineNum = 373;BA.debugLine="Sleep(400)";
...
//C
this.state = 1;
 //BA.debugLineNum = 406;BA.debugLine="Msgbox2Async(\"Applicatie afsluiten?\", Application";
anywheresoftware.b4a.keywords.Common.Msgbox2Async(BA.ObjectToCharSequence("Applicatie afsluiten?"),BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.Application.getLabelName()),"JA","","NEE",anywheresoftware.b4a.keywords.Common.Application.getIcon(),processBA,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 407;BA.debugLine="Wait For Msgbox_Result(Result As Int)";
...
//C
this.state = 1;
 //BA.debugLineNum = 414;BA.debugLine="If edtFloatCode.Text = \"\" Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 415;BA.debugLine="Msgbox2Async(\"Locatie code mag niet leeg zijn\",";
...
this.state = 5;
;
 //BA.debugLineNum = 420;BA.debugLine="Dim ime As IME";
_ime = new anywheresoftware.b4a.objects.IME();
 //BA.debugLineNum = 421;BA.debugLine="ime.Initialize(Me)";
_ime.Initialize(BA.ObjectToString(main.getObject()));
 //BA.debugLineNum = 422;BA.debugLine="Starter.testBaseName = True";
parent.mostCurrent._starter._testbasename /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 423;BA.debugLine="Starter.selectedLocationCode = edtFloatCode.Text";
parent.mostCurrent._starter._selectedlocationcode /*String*/  = parent.mostCurrent._edtfloatcode._gettext /*String*/ ();
 //BA.debugLineNum = 425;BA.debugLine="Starter.SetLastWill(\"bordpubdied\")";
parent.mostCurrent._starter._setlastwill /*String*/ ("bordpubdied");
 //BA.debugLineNum = 427;BA.debugLine="Starter.SetSubBase(Starter.selectedLocationCode)";
parent.mostCurrent._starter._setsubbase /*String*/ (parent.mostCurrent._starter._selectedlocationcode /*String*/ );
 //BA.debugLineNum = 429;BA.debugLine="Starter.SetSubString2(\"/pubbord\")";
parent.mostCurrent._starter._setsubstring2 /*String*/ ("/pubbord");
 //BA.debugLineNum = 431;BA.debugLine="Starter.SetUnsubscribeString2(\"\")";
parent.mostCurrent._starter._setunsubscribestring2 /*String*/ ("");
 //BA.debugLineNum = 432;BA.debugLine="mqttBase.Initialize";
parent._mqttbase._initialize /*String*/ (processBA);
 //BA.debugLineNum = 433;BA.debugLine="Sleep(100)";
...
this.state = 5;
;
 //BA.debugLineNum = 434;BA.debugLine="mqttBase.Connect";
parent._mqttbase._connect /*String*/ ();
 //BA.debugLineNum = 436;BA.debugLine="Sleep(1000)";
...
this.state = 5;
;
 //BA.debugLineNum = 438;BA.debugLine="If mqttBase.connected = False Then";
if (true) break;
...
//C
this.state = 16;
 //BA.debugLineNum = 439;BA.debugLine="Msgbox2Async(\"Kan geen verbinding maken met loca";
anywheresoftware.b4a.keywords.Common.Msgbox2Async(BA.ObjectToCharSequence("Kan geen verbinding maken met locatie"),BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.Application.getLabelName()),"OKE","","",anywheresoftware.b4a.keywords.Common.Application.getIcon(),processBA,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 440;BA.debugLine="Wait For Msgbox_Result(Result As Int)";
anywheresoftware.b4a.keywords.Common.WaitFor("msgbox_result", processBA, this, null);
this.state = 20;
return;
case 20:
...
//C
this.state = 10;
 //BA.debugLineNum = 442;BA.debugLine="Dim code, description As String";
_code = "";
_description = "";
 //BA.debugLineNum = 443;BA.debugLine="lblCurrLocation.Text = edtFloatDescription.Text";
parent.mostCurrent._lblcurrlocation.setText(BA.ObjectToCharSequence(parent.mostCurrent._edtfloatdescription._gettext /*String*/ ()));
 //BA.debugLineNum = 444;BA.debugLine="Starter.selectedLocationDescription = edtFloatDe";
parent.mostCurrent._starter._selectedlocationdescription /*String*/  = parent.mostCurrent._edtfloatdescription._gettext /*String*/ ();
 //BA.debugLineNum = 445;BA.debugLine="code = edtFloatCode.Text";
_code = parent.mostCurrent._edtfloatcode._gettext /*String*/ ();
 //BA.debugLineNum = 446;BA.debugLine="If edtFloatDescription.Text = \"\" Then edtFloatDe";
if (true) break;
...
this.state = 16;
;
 //BA.debugLineNum = 447;BA.debugLine="description = edtFloatDescription.Text";
_description = parent.mostCurrent._edtfloatdescription._gettext /*String*/ ();
 //BA.debugLineNum = 450;BA.debugLine="mqttBase.Disconnect";
parent._mqttbase._disconnect /*String*/ ();
 //BA.debugLineNum = 451;BA.debugLine="pnlLocationCOde.Visible = False";
parent.mostCurrent._pnllocationcode.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 452;BA.debugLine="baseFile.SetBase(code, description, \"1\")";
parent._basefile._setbase /*String*/ (_code,_description,"1");
 //BA.debugLineNum = 453;BA.debugLine="InitConnection";
_initconnection();
 //BA.debugLineNum = 454;BA.debugLine="ime.HideKeyboard";
...
public static boolean  _checkclientconnected() throws Exception{
 //BA.debugLineNum = 474;BA.debugLine="Private Sub CheckClientConnected As Boolean";
 //BA.debugLineNum = 475;BA.debugLine="Return CallSub(mqttBase, \"GetClientConnected\")";
...
public static boolean  _checkconnecttime() throws Exception{
 //BA.debugLineNum = 204;BA.debugLine="Sub checkConnectTime As Boolean";
 //BA.debugLineNum = 205;BA.debugLine="If connectTime <> -1 Then";
if (_connecttime!=-1) { 
 //BA.debugLineNum = 206;BA.debugLine="pnlNobords.Visible = True";
mostCurrent._pnlnobords.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 207;BA.debugLine="mqttBase.Disconnect";
_mqttbase._disconnect /*String*/ ();
 //BA.debugLineNum = 208;BA.debugLine="tmrBordLastAlive.Enabled = False";
_tmrbordlastalive.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 209;BA.debugLine="pnlNobords.Visible = False";
mostCurrent._pnlnobords.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 210;BA.debugLine="Msgbox2Async(\"Geen borden gevonden\", Application";
...
nl.pdeg.bordondroid.main._bordstatus _lst = null;
 //BA.debugLineNum = 304;BA.debugLine="Sub CheckIpExits(bord As Message)";
 //BA.debugLineNum = 305;BA.debugLine="Dim bordExists As Boolean = False";
_bordexists = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 306;BA.debugLine="Dim strPlayers As String";
_strplayers = "";
 //BA.debugLineNum = 307;BA.debugLine="If bord.Body.Length = 0 Then Return";
if (_bord.Body /*String*/ .length()==0) { 
if (true) return "";};
 //BA.debugLineNum = 308;BA.debugLine="Dim name As String = bord.Body";
_name = _bord.Body /*String*/ ;
 //BA.debugLineNum = 311;BA.debugLine="If name.IndexOf(\"|\") > -1 Then";
if (_name.indexOf("|")>-1) { 
 //BA.debugLineNum = 312;BA.debugLine="Dim strData() As String = Regex.Split(\"\\|\", name";
_strdata = anywheresoftware.b4a.keywords.Common.Regex.Split("\\|",_name);
 //BA.debugLineNum = 313;BA.debugLine="name = strData(0)";
_name = _strdata[(int) (0)];
 //BA.debugLineNum = 314;BA.debugLine="strPlayers = $\"${baseFile.NameToCamelCase(strDat";
_strplayers = (""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_basefile._nametocamelcase /*String*/ (_strdata[(int) (1)])))+" - "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_basefile._nametocamelcase /*String*/ (_strdata[(int) (2)])))+"");
 };
 //BA.debugLineNum = 318;BA.debugLine="connectTime = -1";
_connecttime = (long) (-1);
 //BA.debugLineNum = 320;BA.debugLine="If Starter.serverList.Size = 0 Then";
if (mostCurrent._starter._serverlist /*anywheresoftware.b4a.objects.collections.List*/ .getSize()==0) { 
 //BA.debugLineNum = 321;BA.debugLine="AddUnkownIp(\"\", name, strPlayers)";
_addunkownip("",_name,_strplayers);
 //BA.debugLineNum = 322;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 325;BA.debugLine="For Each lst As bordStatus In Starter.serverList";
{
...
_lst = (nl.pdeg.bordondroid.main._bordstatus)(group15.Get(index15));
 //BA.debugLineNum = 326;BA.debugLine="If lst.name = name Then";
if ((_lst.name /*String*/ ).equals(_name)) { 
 //BA.debugLineNum = 327;BA.debugLine="bordExists = True";
_bordexists = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 328;BA.debugLine="lst.timeStamp = DateTime.Now";
_lst.timeStamp /*long*/  = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 329;BA.debugLine="lst.alive = True";
_lst.alive /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 331;BA.debugLine="baseFile.CheckPlayers(strPlayers, name, clvServ";
_basefile._checkplayers /*String*/ (_strplayers,_name,mostCurrent._clvserver);
 };
 }
};
 //BA.debugLineNum = 335;BA.debugLine="If Not(bordExists) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_bordexists)) { 
 //BA.debugLineNum = 336;BA.debugLine="AddUnkownIp(\"\", name, strPlayers)";
_addunkownip("",_name,_strplayers);
...
int _i = 0;
 //BA.debugLineNum = 377;BA.debugLine="Sub CheckIpInClv(bord As bordStatus, players As St";
 //BA.debugLineNum = 378;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 381;BA.debugLine="For i = 0 To clvServer.GetSize-1";
{
final int step2 = 1;
final int limit2 = (int) (mostCurrent._clvserver._getsize()-1);
_i = (int) (0) ;
for (;_i <= limit2 ;_i = _i + step2 ) {
 //BA.debugLineNum = 382;BA.debugLine="p = clvServer.GetPanel(i)";
_p.setObject((android.view.ViewGroup)(mostCurrent._clvserver._getpanel(_i).getObject()));
 //BA.debugLineNum = 383;BA.debugLine="If p.Tag = bord.name Then";
if ((_p.getTag()).equals((Object)(_bord.name /*String*/ ))) { 
 //BA.debugLineNum = 384;BA.debugLine="baseFile.SetPanelLabelItemText(p, \"lblLastCheck";
_basefile._setpanellabelitemtext /*String*/ (_p,"lblLastCheck",("Laatste controle "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("time",(Object)(anywheresoftware.b4a.keywords.Common.DateTime.getNow()))+""));
 //BA.debugLineNum = 385;BA.debugLine="baseFile.SetBordDiedByName(bord.name, clvServer";
_basefile._setborddiedbyname /*String*/ (_bord.name /*String*/ ,mostCurrent._clvserver,_bord.alive /*boolean*/ );
 };
 }
};
 //BA.debugLineNum = 390;BA.debugLine="pnlNobords.SetVisibleAnimated(1000, False)";
mostCurrent._pnlnobords.SetVisibleAnimated((int) (1000),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 391;BA.debugLine="clvServer.Add(genUnitList(bord.name, bord.alive,";
...
nl.pdeg.bordondroid.main._bordstatus _bd = null;
 //BA.debugLineNum = 216;BA.debugLine="Sub CheckLastAliveTime";
 //BA.debugLineNum = 217;BA.debugLine="Dim currTime As Long = DateTime.Now";
_currtime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 218;BA.debugLine="Dim timeDiff As Long";
_timediff = 0L;
 //BA.debugLineNum = 219;BA.debugLine="Dim clvIndex, serverListIndex As Int";
_clvindex = 0;
_serverlistindex = 0;
 //BA.debugLineNum = 222;BA.debugLine="If lblLastCheck.IsInitialized = False Then";
if (mostCurrent._lbllastcheck.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 223;BA.debugLine="lblNoBord.Visible = False";
mostCurrent._lblnobord.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 224;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 227;BA.debugLine="lblLastCheck.Text = $\"Laatste controle $Time{Date";
mostCurrent._lbllastcheck.setText(BA.ObjectToCharSequence(("Laatste controle "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("time",(Object)(anywheresoftware.b4a.keywords.Common.DateTime.getNow()))+"")));
 //BA.debugLineNum = 229;BA.debugLine="For Each bd As bordStatus In Starter.serverList";
{
...
_bd = (nl.pdeg.bordondroid.main._bordstatus)(group9.Get(index9));
 //BA.debugLineNum = 230;BA.debugLine="timeDiff = currTime-bd.timeStamp";
_timediff = (long) (_currtime-_bd.timeStamp /*long*/ );
 //BA.debugLineNum = 232;BA.debugLine="If timeDiff >= Starter.serverDiedRemove Then";
if (_timediff>=mostCurrent._starter._serverdiedremove /*long*/ ) { 
 //BA.debugLineNum = 233;BA.debugLine="clvIndex = baseFile.GetPanelIndexFromBordName(b";
_clvindex = _basefile._getpanelindexfrombordname /*int*/ (_bd.name /*String*/ ,mostCurrent._clvserver);
 //BA.debugLineNum = 234;BA.debugLine="serverListIndex = baseFile.GetServerlistIndexFr";
_serverlistindex = _basefile._getserverlistindexfromname /*int*/ (_bd.name /*String*/ );
 //BA.debugLineNum = 235;BA.debugLine="If clvIndex <> -1 Then";
if (_clvindex!=-1) { 
 //BA.debugLineNum = 236;BA.debugLine="clvServer.RemoveAt(clvIndex)";
mostCurrent._clvserver._removeat(_clvindex);
 };
 //BA.debugLineNum = 238;BA.debugLine="If serverListIndex <> -1 Then";
if (_serverlistindex!=-1) { 
 //BA.debugLineNum = 239;BA.debugLine="Starter.serverList.RemoveAt(serverListIndex)";
...
//C
this.state = 1;
 //BA.debugLineNum = 181;BA.debugLine="Dim p As Panel = clvServer.GetPanel(Index)";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
_p.setObject((android.view.ViewGroup)(parent.mostCurrent._clvserver._getpanel(_index).getObject()));
 //BA.debugLineNum = 182;BA.debugLine="Dim unit As String";
_unit = "";
 //BA.debugLineNum = 184;BA.debugLine="unit = baseFile.GetSelectedLabelTagFromPanel(p, \"";
_unit = parent._basefile._getselectedlabeltagfrompanel /*String*/ (_p,"name");
 //BA.debugLineNum = 185;BA.debugLine="If baseFile.GetBordAlive(unit) = False Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 186;BA.debugLine="baseFile.ShowCustomToast($\"Bord niet gevonden, c";
...
this.state = -1;
;
 //BA.debugLineNum = 190;BA.debugLine="Starter.DiscoveredServer = unit";
parent.mostCurrent._starter._discoveredserver /*String*/  = _unit;
 //BA.debugLineNum = 191;BA.debugLine="CallSub2(Starter, \"SetLastWill\", \"recvdied\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(parent.mostCurrent._starter.getObject()),"SetLastWill",(Object)("recvdied"));
 //BA.debugLineNum = 192;BA.debugLine="CallSub2(Starter, \"SetUnit\", PrepTopicName(unit).";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(parent.mostCurrent._starter.getObject()),"SetUnit",(Object)(_preptopicname(_unit).toLowerCase()));
 //BA.debugLineNum = 194;BA.debugLine="DisconnectMqtt";
_disconnectmqtt();
...
this.state = -1;
;
 //BA.debugLineNum = 196;BA.debugLine="StartActivity(ServerBoard)";
...
public static String  _connectionerror() throws Exception{
 //BA.debugLineNum = 504;BA.debugLine="Sub ConnectionError";
 //BA.debugLineNum = 505;BA.debugLine="baseFile.ShowCustomToast(\"MQTT Fout\", True, Color";
...
public static String  _deletedlocationactive() throws Exception{
 //BA.debugLineNum = 494;BA.debugLine="Sub DeletedLocationActive";
 //BA.debugLineNum = 495;BA.debugLine="mqttBase.Disconnect";
_mqttbase._disconnect /*String*/ ();
 //BA.debugLineNum = 496;BA.debugLine="clvServer.Clear";
mostCurrent._clvserver._clear();
 //BA.debugLineNum = 497;BA.debugLine="getBaseList";
_getbaselist();
...
public static String  _disconnectmqtt() throws Exception{
 ...
 //BA.debugLineNum = 277;BA.debugLine="If mqttBase.connected Then";
if (_mqttbase._connected /*boolean*/ ) { 
 //BA.debugLineNum = 278;BA.debugLine="mqttBase.Disconnect";
_mqttbase._disconnect /*String*/ ();
 };
 //BA.debugLineNum = 280;BA.debugLine="If CheckClientConnected Then";
if (_checkclientconnected()) { 
 //BA.debugLineNum = 281;BA.debugLine="mqttBase.Disconnect";
_mqttbase._disconnect /*String*/ ();
 };
...
public static String  _edtfloatcode_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 486;BA.debugLine="Sub edtFloatCode_TextChanged (Old As String, New A";
 //BA.debugLineNum = 487;BA.debugLine="If New.Length > 0 Then";
if (_new.length()>0) { 
 //BA.debugLineNum = 488;BA.debugLine="btnOk.Enabled = True";
mostCurrent._btnok.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 490;BA.debugLine="btnOk.Enabled = False";
...
public static String  _edtfloatdescription_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 482;BA.debugLine="Sub edtFloatDescription_TextChanged (Old As String";
 //BA.debugLineNum = 484;BA.debugLine="End Sub";
return "";
}
public static String  _edtlocationcode_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 458;BA.debugLine="Sub edtLocationCode_TextChanged (Old As String, Ne";
 //BA.debugLineNum = 459;BA.debugLine="If New.Length > 0 Then";
if (_new.length()>0) { 
 //BA.debugLineNum = 460;BA.debugLine="btnOk.Enabled = True";
mostCurrent._btnok.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 462;BA.debugLine="btnOk.Enabled = False";
mostCurrent._btnok.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 };
...
_p.Initialize(mostCurrent.activityBA,BA.ObjectToString(main.getObject()));
 //BA.debugLineNum = 289;BA.debugLine="p.SetLayout(0dip, 0dip, clvServer.AsView.Width, 9";
...
mostCurrent._lbllastcheck.setText(BA.ObjectToCharSequence(("Laatste controle "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("time",(Object)(anywheresoftware.b4a.keywords.Common.DateTime.getNow()))+"")));
 //BA.debugLineNum = 295;BA.debugLine="lblPLayer.Text = players";
mostCurrent._lblplayer.setText(BA.ObjectToCharSequence(_players));
 //BA.debugLineNum = 296;BA.debugLine="lblPLayer.Tag = \"players\"";
mostCurrent._lblplayer.setTag((Object)("players"));
 //BA.debugLineNum = 297;BA.debugLine="BordDiedProgress.Show";
mostCurrent._borddiedprogress._show /*String*/ ();
 //BA.debugLineNum = 298;BA.debugLine="If Not(alive) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_alive)) { 
 //BA.debugLineNum = 299;BA.debugLine="lblViewBord.Enabled = False";
mostCurrent._lblviewbord.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 301;BA.debugLine="Return p";
if (true) return _p;
...
//C
this.state = 1;
 //BA.debugLineNum = 116;BA.debugLine="Dim listSize As Int = 0";
_listsize = (int) (0);
 //BA.debugLineNum = 118;BA.debugLine="baseList.Initialize";
parent._baselist.Initialize();
 //BA.debugLineNum = 119;BA.debugLine="baseList = baseFile.GetBase";
parent._baselist = parent._basefile._getbase /*anywheresoftware.b4a.objects.collections.List*/ ();
 //BA.debugLineNum = 121;BA.debugLine="If CallSub(baseFile, \"CheckBaseListExists\") = Fal";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 122;BA.debugLine="pnlLocationCOde.Visible = True";
...
if (true) return ;
 if (true) break;
;
 //BA.debugLineNum = 126;BA.debugLine="If baseList.IsInitialized Then";
...
//C
this.state = 7;
 //BA.debugLineNum = 127;BA.debugLine="listSize = baseList.Size";
_listsize = parent._baselist.getSize();
 if (true) break;
;
 //BA.debugLineNum = 129;BA.debugLine="If listSize > 1 Then";
...
//C
this.state = 12;
 //BA.debugLineNum = 131;BA.debugLine="pnlLocationList.SetVisibleAnimated(500, True)";
parent.mostCurrent._pnllocationlist.SetVisibleAnimated((int) (500),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 132;BA.debugLine="Sleep(200)";
...
//C
this.state = 12;
 //BA.debugLineNum = 134;BA.debugLine="pnlLocationList.SetVisibleAnimated(500, False)";
...
this.state = 13;
;
 //BA.debugLineNum = 138;BA.debugLine="lblNoBord.Text = \"Wachten op borden...\"";
parent.mostCurrent._lblnobord.setText(BA.ObjectToCharSequence("Wachten op borden..."));
 //BA.debugLineNum = 140;BA.debugLine="If baseList.IsInitialized = False Then";
if (true) break;
...
//C
this.state = 20;
 //BA.debugLineNum = 141;BA.debugLine="pnlLocationCOde.Visible = True";
parent.mostCurrent._pnllocationcode.setVisible(anywheresoftware.b4a.keywords.Common.True);
 if (true) break;
...
//C
this.state = 20;
 //BA.debugLineNum = 143;BA.debugLine="Dim loc As locationBord";
_loc = new nl.pdeg.bordondroid.main._locationbord();
 //BA.debugLineNum = 144;BA.debugLine="loc.Initialize";
_loc.Initialize();
 //BA.debugLineNum = 145;BA.debugLine="loc = baseList.Get(0)";
_loc = (nl.pdeg.bordondroid.main._locationbord)(parent._baselist.Get((int) (0)));
 //BA.debugLineNum = 146;BA.debugLine="Starter.selectedLocationCode = loc.code";
parent.mostCurrent._starter._selectedlocationcode /*String*/  = _loc.code /*String*/ ;
 //BA.debugLineNum = 147;BA.debugLine="Starter.selectedLocationDescription = loc.descri";
parent.mostCurrent._starter._selectedlocationdescription /*String*/  = _loc.description /*String*/ ;
 //BA.debugLineNum = 148;BA.debugLine="lblCurrLocation.Text = loc.description";
parent.mostCurrent._lblcurrlocation.setText(BA.ObjectToCharSequence(_loc.description /*String*/ ));
 //BA.debugLineNum = 149;BA.debugLine="InitConnection";
_initconnection();
 if (true) break;
...
//C
this.state = 20;
 //BA.debugLineNum = 151;BA.debugLine="StartActivity(SelectLocation)";
...
//C
this.state = 1;
 //BA.debugLineNum = 167;BA.debugLine="If mqttBase.connected Then mqttBase.Disconnect";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 168;BA.debugLine="Starter.serverList.Initialize";
parent.mostCurrent._starter._serverlist /*anywheresoftware.b4a.objects.collections.List*/ .Initialize();
 //BA.debugLineNum = 169;BA.debugLine="clvServer.Clear";
parent.mostCurrent._clvserver._clear();
 //BA.debugLineNum = 170;BA.debugLine="lblCurrLocation.Text = Starter.selectedLocationDe";
...
this.state = -1;
;
 //BA.debugLineNum = 176;BA.debugLine="StartConnection";
_startconnection();
...
anywheresoftware.b4a.objects.PanelWrapper _p = null;
 //BA.debugLineNum = 394;BA.debugLine="Sub lblViewBord_Click";
 //BA.debugLineNum = 395;BA.debugLine="Dim v As View = Sender";
_v = new anywheresoftware.b4a.objects.ConcreteViewWrapper();
_v.setObject((android.view.View)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 396;BA.debugLine="Dim p As Panel = v.Parent";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
_p.setObject((android.view.ViewGroup)(_v.getParent()));
 //BA.debugLineNum = 398;BA.debugLine="clvServer_ItemClick (clvServer.GetItemFromView(p)";
...
public static String  _pnllocation_click() throws Exception{
 //BA.debugLineNum = 466;BA.debugLine="Sub pnlLocation_Click";
 //BA.debugLineNum = 468;BA.debugLine="If CheckClientConnected Then";
if (_checkclientconnected()) { 
 //BA.debugLineNum = 469;BA.debugLine="mqttBase.Disconnect";
_mqttbase._disconnect /*String*/ ();
 };
 //BA.debugLineNum = 471;BA.debugLine="StartActivity(locations)";
...
public static String  _pnllocationlist_click() throws Exception{
 //BA.debugLineNum = 478;BA.debugLine="Sub pnlLocationList_Click";
 //BA.debugLineNum = 479;BA.debugLine="StartActivity(SelectLocation)";
...
public static String  _preptopicname(String _bord) throws Exception{
 //BA.debugLineNum = 401;BA.debugLine="Private Sub PrepTopicName(bord As String) As Strin";
 //BA.debugLineNum = 402;BA.debugLine="Return bord.Replace(\" \", \"\")";
...
public static String  _reconnecttolocation() throws Exception{
 //BA.debugLineNum = 155;BA.debugLine="Sub ReconnectToLocation";
 //BA.debugLineNum = 156;BA.debugLine="mqttBase.Initialize";
_mqttbase._initialize /*String*/ (processBA);
 //BA.debugLineNum = 157;BA.debugLine="CallSub2(Starter, \"SetLastWill\", \"bordpubdied\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._starter.getObject()),"SetLastWill",(Object)("bordpubdied"));
 //BA.debugLineNum = 158;BA.debugLine="CallSub2(Starter, \"SetSubBase\", Starter.selectedL";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._starter.getObject()),"SetSubBase",(Object)(mostCurrent._starter._selectedlocationcode /*String*/ ));
 //BA.debugLineNum = 159;BA.debugLine="CallSub2(Starter, \"SetSubString2\", \"/pubbord\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._starter.getObject()),"SetSubString2",(Object)("/pubbord"));
 //BA.debugLineNum = 160;BA.debugLine="CallSub2(Starter, \"SetUnsubscribeString2\", \"\")";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._starter.getObject()),"SetUnsubscribeString2",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="mqttBase.Connect";
_mqttbase._connect /*String*/ ();
...
public static String  _setbordlastalivetimer() throws Exception{
 //BA.debugLineNum = 88;BA.debugLine="Sub setBordLastAliveTimer";
 //BA.debugLineNum = 89;BA.debugLine="tmrBordLastAlive.Enabled = True";
...
public static String  _shownotconnectedtobroker() throws Exception{
 //BA.debugLineNum = 255;BA.debugLine="Sub ShowNotConnectedToBroker";
 //BA.debugLineNum = 256;BA.debugLine="lblNoBord.Text = \"Verbinding borden verbroken\"";
mostCurrent._lblnobord.setText(BA.ObjectToCharSequence("Verbinding borden verbroken"));
 //BA.debugLineNum = 257;BA.debugLine="pnlNobords.SetVisibleAnimated(1000, True)";
...
public static String  _showselectlocationbutton() throws Exception{
 //BA.debugLineNum = 500;BA.debugLine="Sub ShowSelectLocationButton";
 //BA.debugLineNum = 501;BA.debugLine="pnlLocationList.Visible = baseFile.GetBase.Size >";
...
//C
this.state = -1;
 //BA.debugLineNum = 94;BA.debugLine="pnlLocationCOde.Visible = False";
parent.mostCurrent._pnllocationcode.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 95;BA.debugLine="B4XLoadingIndicator1.Show";
parent.mostCurrent._b4xloadingindicator1._show /*String*/ ();
 //BA.debugLineNum = 96;BA.debugLine="B4XLoadingIndicator2.Show";
parent.mostCurrent._b4xloadingindicator2._show /*String*/ ();
 //BA.debugLineNum = 97;BA.debugLine="Sleep(10)";
...
this.state = -1;
;
 //BA.debugLineNum = 98;BA.debugLine="pnlNobords.Visible = True";
parent.mostCurrent._pnlnobords.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 99;BA.debugLine="clvServer.Clear";
parent.mostCurrent._clvserver._clear();
 //BA.debugLineNum = 100;BA.debugLine="mqttBase.Initialize";
parent._mqttbase._initialize /*String*/ (processBA);
 //BA.debugLineNum = 101;BA.debugLine="mqttBase.Connect";
parent._mqttbase._connect /*String*/ ();
 //BA.debugLineNum = 103;BA.debugLine="baseFile.GetBase";
parent._basefile._getbase /*anywheresoftware.b4a.objects.collections.List*/ ();
 //BA.debugLineNum = 105;BA.debugLine="tmrBordLastAlive.Initialize(\"tmrBordAlive\", 10000";
...
parent._tmrbordlastalive.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 107;BA.debugLine="connectTime = DateTime.Now";
...
public static String  _tmrbordalive_tick() throws Exception{
 //BA.debugLineNum = 199;BA.debugLine="Sub tmrBordAlive_Tick";
 //BA.debugLineNum = 200;BA.debugLine="If Not(checkConnectTime) Then Return";
if (anywheresoftware.b4a.keywords.Common.Not(_checkconnecttime())) { 
if (true) return "";};
 //BA.debugLineNum = 201;BA.debugLine="CheckLastAliveTime";
_checklastalivetime();
