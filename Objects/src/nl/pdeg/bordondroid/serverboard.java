...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 102;BA.debugLine="Private Sub Activity_KeyPress(KeyCode As Int) As B";
 //BA.debugLineNum = 103;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 104;BA.debugLine="DisconnetMqtt";
_disconnetmqtt();
 //BA.debugLineNum = 105;BA.debugLine="CallSubDelayed(Main, \"setBordLastAliveTimer\")";
anywheresoftware.b4a.keywords.Common.CallSubDelayed(processBA,(Object)(mostCurrent._main.getObject()),"setBordLastAliveTimer");
 //BA.debugLineNum = 106;BA.debugLine="lastMessageTimer.Enabled = False";
_lastmessagetimer.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 107;BA.debugLine="CallSubDelayed(Main, \"ReconnectToLocation\")";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 72;BA.debugLine="ResumeConnection(False)";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 68;BA.debugLine="ResumeConnection(True)";
...
public static String  _disconnetmqtt() throws Exception{
 //BA.debugLineNum = 95;BA.debugLine="Sub DisconnetMqtt";
 //BA.debugLineNum = 96;BA.debugLine="If mqttBase.connected Then";
if (_mqttbase._connected /*boolean*/ ) { 
 //BA.debugLineNum = 97;BA.debugLine="mqttBase.Disconnect";
...
public static String  _gamedended() throws Exception{
 //BA.debugLineNum = 173;BA.debugLine="Public Sub GamedEnded";
 //BA.debugLineNum = 174;BA.debugLine="lblSpelduur.TextColor = Colors.Red";
mostCurrent._lblspelduur.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 175;BA.debugLine="Msgbox2Async(\"Spel beëindigd\", Application.LabelN";
...
//C
this.state = 1;
 //BA.debugLineNum = 202;BA.debugLine="If imgNoData.Visible Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 203;BA.debugLine="imgNoData.SetVisibleAnimated(0, False)";
parent.mostCurrent._imgnodata.SetVisibleAnimated((int) (0),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 204;BA.debugLine="Sleep(300)";
...
//C
this.state = 1;
 //BA.debugLineNum = 76;BA.debugLine="If resume Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 77;BA.debugLine="If mqttBase.GetClientConnected Then Return";
if (true) break;
...
this.state = 10;
;
 //BA.debugLineNum = 78;BA.debugLine="lastMessageTime = DateTime.Now";
parent._lastmessagetime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 79;BA.debugLine="If mqttBase.GetClientConnected = False Then";
if (true) break;
...
//C
this.state = 13;
 //BA.debugLineNum = 80;BA.debugLine="mqttBase.Connect";
...
this.state = 16;
;
 //BA.debugLineNum = 82;BA.debugLine="Sleep(500)";
...
this.state = 16;
;
 //BA.debugLineNum = 83;BA.debugLine="mqttBase.SendMessage(\"data please\")";
parent._mqttbase._sendmessage /*String*/ ("data please");
 //BA.debugLineNum = 84;BA.debugLine="lastMessageTimer.Initialize(\"tmrLastMessase\", 12";
parent._lastmessagetimer.Initialize(processBA,"tmrLastMessase",(long) (120*1000));
 //BA.debugLineNum = 85;BA.debugLine="lastMessageTimer.Enabled = True";
parent._lastmessagetimer.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 86;BA.debugLine="lastMessageTime = DateTime.Now";
parent._lastmessagetime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 if (true) break;
...
//C
this.state = 16;
 //BA.debugLineNum = 88;BA.debugLine="mqttBase.Disconnect";
parent._mqttbase._disconnect /*String*/ ();
 //BA.debugLineNum = 89;BA.debugLine="lastMessageTimer.Enabled = False";
parent._lastmessagetimer.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 92;BA.debugLine="lastMessageTimer.Enabled = resume";
...
String _bmpname = "";
int _nuleen = 0;
 //BA.debugLineNum = 178;BA.debugLine="Private Sub SetImgSponsor";
 //BA.debugLineNum = 179;BA.debugLine="Dim bmp As Bitmap";
_bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 180;BA.debugLine="Dim bmpName As String";
_bmpname = "";
 //BA.debugLineNum = 181;BA.debugLine="Dim nuleen As Int = Rnd(0,3)";
_nuleen = anywheresoftware.b4a.keywords.Common.Rnd((int) (0),(int) (3));
 //BA.debugLineNum = 183;BA.debugLine="If nuleen = 0 Then";
if (_nuleen==0) { 
 //BA.debugLineNum = 184;BA.debugLine="bmpName = \"sven1.jpg\"";
_bmpname = "sven1.jpg";
 };
 //BA.debugLineNum = 186;BA.debugLine="If nuleen = 1 Then";
if (_nuleen==1) { 
 //BA.debugLineNum = 187;BA.debugLine="bmpName = \"sven_oud.jpg\"";
_bmpname = "sven_oud.jpg";
 };
 //BA.debugLineNum = 189;BA.debugLine="If nuleen = 2 Then";
if (_nuleen==2) { 
 //BA.debugLineNum = 190;BA.debugLine="bmpName = \"biljarter.png\"";
_bmpname = "biljarter.png";
 };
 //BA.debugLineNum = 193;BA.debugLine="bmp = LoadBitmapResize(File.DirAssets, bmpName, i";
_bmp = anywheresoftware.b4a.keywords.Common.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),_bmpname,mostCurrent._imgsponsor.getWidth(),mostCurrent._imgsponsor.getHeight(),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 194;BA.debugLine="imgSponsor.SetBackgroundImage(bmp)";
...
public static String  _tmrlastmessase_tick() throws Exception{
 ...
 //BA.debugLineNum = 61;BA.debugLine="If (DateTime.Now-lastMessageTime) >= 120*1000 The";
...
_mqttbase._sendmessage /*String*/ ("data please");
 //BA.debugLineNum = 63;BA.debugLine="lblSpelduur.TextColor = Colors.Red";
mostCurrent._lblspelduur.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 };
...
String _aantal = "";
 //BA.debugLineNum = 114;BA.debugLine="public Sub UpdateBordWhenClient(data As Message)";
 //BA.debugLineNum = 115;BA.debugLine="HideWaitLabel";
_hidewaitlabel();
 //BA.debugLineNum = 116;BA.debugLine="lastMessageTime = DateTime.Now";
_lastmessagetime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 117;BA.debugLine="lblSpelduur.TextColor = Colors.White";
mostCurrent._lblspelduur.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 118;BA.debugLine="Dim Number, str As String";
_number = "";
_str = "";
 //BA.debugLineNum = 119;BA.debugLine="str = data.Body";
_str = _data.Body /*String*/ ;
 //BA.debugLineNum = 121;BA.debugLine="parser.Initialize(str)";
...
_root = mostCurrent._parser.NextObject();
 //BA.debugLineNum = 123;BA.debugLine="Dim score As Map = root.Get(\"score\")";
...
_score.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_root.Get((Object)("score"))));
 //BA.debugLineNum = 124;BA.debugLine="Dim p1 As Map = score.Get(\"p1\")";
...
_p1.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_score.Get((Object)("p1"))));
 //BA.debugLineNum = 125;BA.debugLine="Dim p2 As Map = score.Get(\"p2\")";
...
_p2.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_score.Get((Object)("p2"))));
 //BA.debugLineNum = 127;BA.debugLine="Dim aan_stoot As Map = score.Get(\"aan_stoot\")";
...
_aan_stoot.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_score.Get((Object)("aan_stoot"))));
 //BA.debugLineNum = 128;BA.debugLine="Dim speler As String = aan_stoot.Get(\"speler\")";
_speler = BA.ObjectToString(_aan_stoot.Get((Object)("speler")));
 //BA.debugLineNum = 129;BA.debugLine="Dim spelduur As Map = score.Get(\"spelduur\")";
...
_spelduur.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_score.Get((Object)("spelduur"))));
 //BA.debugLineNum = 130;BA.debugLine="Dim tijd As String = spelduur.Get(\"tijd\")";
_tijd = BA.ObjectToString(_spelduur.Get((Object)("tijd")));
 //BA.debugLineNum = 131;BA.debugLine="Dim beurten As Map = score.Get(\"beurten\")";
...
_beurten.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_score.Get((Object)("beurten"))));
 //BA.debugLineNum = 132;BA.debugLine="Dim aantal As String = beurten.Get(\"aantal\")";
_aantal = BA.ObjectToString(_beurten.Get((Object)("aantal")));
 //BA.debugLineNum = 134;BA.debugLine="lblP1Name.Text = p1.Get(\"naam\")";
mostCurrent._lblp1name.setText(BA.ObjectToCharSequence(_p1.Get((Object)("naam"))));
 //BA.debugLineNum = 135;BA.debugLine="Number = p1.Get(\"caram\")";
_number = BA.ObjectToString(_p1.Get((Object)("caram")));
 //BA.debugLineNum = 136;BA.debugLine="lblP1100.Text = Number.SubString2(0,1)";
mostCurrent._lblp1100.setText(BA.ObjectToCharSequence(_number.substring((int) (0),(int) (1))));
 //BA.debugLineNum = 137;BA.debugLine="lblP110.Text = Number.SubString2(1,2)";
mostCurrent._lblp110.setText(BA.ObjectToCharSequence(_number.substring((int) (1),(int) (2))));
 //BA.debugLineNum = 138;BA.debugLine="lblP11.Text = Number.SubString2(2,3)";
mostCurrent._lblp11.setText(BA.ObjectToCharSequence(_number.substring((int) (2),(int) (3))));
 //BA.debugLineNum = 139;BA.debugLine="Number = p1.Get(\"maken\")";
_number = BA.ObjectToString(_p1.Get((Object)("maken")));
 //BA.debugLineNum = 140;BA.debugLine="lblP1Maken100.Text = Number.SubString2(0,1)";
mostCurrent._lblp1maken100.setText(BA.ObjectToCharSequence(_number.substring((int) (0),(int) (1))));
 //BA.debugLineNum = 141;BA.debugLine="lblP1Maken10.Text = Number.SubString2(1,2)";
mostCurrent._lblp1maken10.setText(BA.ObjectToCharSequence(_number.substring((int) (1),(int) (2))));
 //BA.debugLineNum = 142;BA.debugLine="lblP1Maken1.Text = Number.SubString2(2,3)";
mostCurrent._lblp1maken1.setText(BA.ObjectToCharSequence(_number.substring((int) (2),(int) (3))));
 //BA.debugLineNum = 143;BA.debugLine="lblP1Moy.Text = cs.Initialize.Typeface(Typeface.F";
...
_cs.Initialize().Append(BA.ObjectToCharSequence("")).Typeface(anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME()).Append(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.Chr((int) (0xf201)))).PopAll();
 //BA.debugLineNum = 156;BA.debugLine="lblP2Moy.Text = cs.Initialize.Typeface(Typeface.F";
mostCurrent._lblp2moy.setText(BA.ObjectToCharSequence(_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME()).Append(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.Chr((int) (0xf201)))).Append(BA.ObjectToCharSequence("  ")).Append(BA.ObjectToCharSequence(_p2.Get((Object)("moyenne")))).PopAll().getObject()));
 //BA.debugLineNum = 158;BA.debugLine="lblBeurt100.Text = aantal.SubString2(0,1)";
mostCurrent._lblbeurt100.setText(BA.ObjectToCharSequence(_aantal.substring((int) (0),(int) (1))));
 //BA.debugLineNum = 159;BA.debugLine="lblBeurt10.Text = aantal.SubString2(1,2)";
mostCurrent._lblbeurt10.setText(BA.ObjectToCharSequence(_aantal.substring((int) (1),(int) (2))));
 //BA.debugLineNum = 160;BA.debugLine="lblBeurt1.Text = aantal.SubString2(2,3)";
mostCurrent._lblbeurt1.setText(BA.ObjectToCharSequence(_aantal.substring((int) (2),(int) (3))));
 //BA.debugLineNum = 161;BA.debugLine="lblSpelduur.Text = tijd'score.Get(\"spelduur\")";
mostCurrent._lblspelduur.setText(BA.ObjectToCharSequence(_tijd));
 //BA.debugLineNum = 162;BA.debugLine="lblSpelduur.Text = cs.Initialize.Typeface(Typefac";
mostCurrent._lblspelduur.setText(BA.ObjectToCharSequence(_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME()).Append(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.Chr((int) (0xf253)))).Append(BA.ObjectToCharSequence("  ")).Append(BA.ObjectToCharSequence(_tijd)).PopAll().getObject()));
 //BA.debugLineNum = 164;BA.debugLine="imgP1Play.Visible = False";
mostCurrent._imgp1play.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 165;BA.debugLine="imgP2Play.Visible = False";
mostCurrent._imgp2play.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 166;BA.debugLine="If speler = 1 Then";
if ((_speler).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 167;BA.debugLine="imgP1Play.Visible = True";
mostCurrent._imgp1play.setVisible(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 169;BA.debugLine="imgP2Play.Visible = True";
