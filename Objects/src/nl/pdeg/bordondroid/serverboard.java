 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            ...
            BA.LogInfo("** Activity (serverboard) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 28;BA.debugLine="If Not (mqttBase.IsInitialized) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_mqttbase.IsInitialized /*boolean*/ ())) { 
 //BA.debugLineNum = 29;BA.debugLine="mqttBase.Initialize";
_mqttbase._initialize /*String*/ (processBA);
 };
 //BA.debugLineNum = 31;BA.debugLine="baseFile.Initialize";
_basefile._initialize /*String*/ (processBA);
 //BA.debugLineNum = 32;BA.debugLine="CallSub(Starter, \"SetSubString\")";
anywheresoftware.b4a.keywords.Common.CallSubNew(processBA,(Object)(mostCurrent._starter.getObject()),"SetSubString");
 //BA.debugLineNum = 34;BA.debugLine="Activity.LoadLayout(\"ServerBoard\")";
mostCurrent._activity.LoadLayout("ServerBoard",mostCurrent.activityBA);
 //BA.debugLineNum = 35;BA.debugLine="SetImgSponsor";
_setimgsponsor();
 //BA.debugLineNum = 36;BA.debugLine="lblTafelNaam.Text = Starter.DiscoveredServer";
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 97;BA.debugLine="Private Sub Activity_KeyPress(KeyCode As Int) As B";
 //BA.debugLineNum = 98;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 99;BA.debugLine="lastMessageTimer.Enabled = False";
_lastmessagetimer.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 100;BA.debugLine="DisconnetMqtt";
_disconnetmqtt();
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 67;BA.debugLine="ResumeConnection(False)";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 63;BA.debugLine="ResumeConnection(True)";
_resumeconnection(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 64;BA.debugLine="End Sub";
return "";
}
public static String  _disconnetmqtt() throws Exception{
 //BA.debugLineNum = 90;BA.debugLine="Sub DisconnetMqtt";
 //BA.debugLineNum = 91;BA.debugLine="If mqttBase.connected Then";
if (_mqttbase._connected /*boolean*/ ) { 
 //BA.debugLineNum = 92;BA.debugLine="mqttBase.Disconnect";
...
public static String  _gamedended() throws Exception{
 //BA.debugLineNum = 172;BA.debugLine="Public Sub GamedEnded";
 //BA.debugLineNum = 173;BA.debugLine="lblSpelduur.TextColor = Colors.Red";
mostCurrent._lblspelduur.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 174;BA.debugLine="Msgbox2Async(\"Spel beëindigd\", Application.LabelN";
...
//C
this.state = 1;
 //BA.debugLineNum = 205;BA.debugLine="If imgNoData.Visible Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 206;BA.debugLine="imgNoData.SetVisibleAnimated(0, False)";
parent.mostCurrent._imgnodata.SetVisibleAnimated((int) (0),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 207;BA.debugLine="Sleep(300)";
...
//C
this.state = 1;
 //BA.debugLineNum = 71;BA.debugLine="lastMessageTime = DateTime.Now";
parent._lastmessagetime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 73;BA.debugLine="If mqttBase.GetClientConnected Then Return";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 74;BA.debugLine="If mqttBase.GetClientConnected = False Then";
if (true) break;

case 7:
//if
this.state = 10;
if (parent._mqttbase._getclientconnected /*boolean*/ ()==anywheresoftware.b4a.keywords.Common.False) { 
this.state = 9;
}if (true) break;
...
parent._mqttbase._sendmessage /*String*/ ("data please");
 //BA.debugLineNum = 79;BA.debugLine="lastMessageTimer.Initialize(\"tmrLastMessase\", 90";
parent._lastmessagetimer.Initialize(processBA,"tmrLastMessase",(long) (90*1000));
 //BA.debugLineNum = 80;BA.debugLine="lastMessageTimer.Enabled = True";
parent._lastmessagetimer.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 81;BA.debugLine="lastMessageTime = DateTime.Now";
parent._lastmessagetime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 87;BA.debugLine="lastMessageTimer.Enabled = resume";
...
String _bmpname = "";
int _nuleen = 0;
 //BA.debugLineNum = 177;BA.debugLine="Private Sub SetImgSponsor";
 //BA.debugLineNum = 178;BA.debugLine="Dim bmp As Bitmap";
_bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 179;BA.debugLine="Dim bmpName As String";
_bmpname = "";
 //BA.debugLineNum = 180;BA.debugLine="Dim nuleen As Int = Rnd(0,4)";
_nuleen = anywheresoftware.b4a.keywords.Common.Rnd((int) (0),(int) (4));
 //BA.debugLineNum = 182;BA.debugLine="If nuleen = 0 Then";
if (_nuleen==0) { 
 //BA.debugLineNum = 183;BA.debugLine="bmpName = \"sven1.jpg\"";
_bmpname = "sven1.jpg";
 };
 //BA.debugLineNum = 185;BA.debugLine="If nuleen = 1 Then";
if (_nuleen==1) { 
 //BA.debugLineNum = 186;BA.debugLine="bmpName = \"sven_oud.jpg\"";
_bmpname = "sven_oud.jpg";
 };
 //BA.debugLineNum = 188;BA.debugLine="If nuleen = 2 Then";
if (_nuleen==2) { 
 //BA.debugLineNum = 189;BA.debugLine="bmpName = \"biljarter.png\"";
_bmpname = "biljarter.png";
 };
 //BA.debugLineNum = 191;BA.debugLine="If nuleen = 3 Then";
if (_nuleen==3) { 
 //BA.debugLineNum = 192;BA.debugLine="bmpName = \"rob.jpg\"";
_bmpname = "rob.jpg";
 };
 //BA.debugLineNum = 195;BA.debugLine="bmpName = \"rva.png\"";
_bmpname = "rva.png";
 //BA.debugLineNum = 196;BA.debugLine="bmp = LoadBitmapResize(File.DirAssets, bmpName, i";
_bmp = anywheresoftware.b4a.keywords.Common.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),_bmpname,mostCurrent._imgsponsor.getWidth(),mostCurrent._imgsponsor.getHeight(),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 197;BA.debugLine="imgSponsor.SetBackgroundImage(bmp)";
...
nl.pdeg.bordondroid.main._bordstatus _bs = null;
 //BA.debugLineNum = 47;BA.debugLine="Sub tmrLastMessase_Tick";
 //BA.debugLineNum = 48;BA.debugLine="If (DateTime.Now-lastMessageTime) >= 90*1000 Then";
if ((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_lastmessagetime)>=90*1000) { 
 //BA.debugLineNum = 49;BA.debugLine="mqttBase.SendMessage(\"data please\")";
_mqttbase._sendmessage /*String*/ ("data please");
 //BA.debugLineNum = 50;BA.debugLine="baseFile.createCustomToast(\"Verbinding met bord";
_basefile._createcustomtoast /*String*/ ("Verbinding met bord verbroken",BA.NumberToString(anywheresoftware.b4a.keywords.Common.Colors.Red));
 //BA.debugLineNum = 51;BA.debugLine="lblSpelduur.TextColor = Colors.Red";
mostCurrent._lblspelduur.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 52;BA.debugLine="Dim ph As PhoneVibrate";
_ph = new anywheresoftware.b4a.phone.Phone.PhoneVibrate();
 //BA.debugLineNum = 53;BA.debugLine="ph.Vibrate(100)";
_ph.Vibrate(processBA,(long) (100));
 //BA.debugLineNum = 54;BA.debugLine="Dim index As Int = baseFile.GetServerlistIndexFr";
_index = _basefile._getserverlistindexfromname /*int*/ (mostCurrent._starter._discoveredserver /*String*/ );
 //BA.debugLineNum = 55;BA.debugLine="Dim bs As bordStatus";
_bs = new nl.pdeg.bordondroid.main._bordstatus();
 //BA.debugLineNum = 56;BA.debugLine="bs.Initialize";
_bs.Initialize();
 //BA.debugLineNum = 57;BA.debugLine="bs = Starter.serverList.Get(index)";
_bs = (nl.pdeg.bordondroid.main._bordstatus)(mostCurrent._starter._serverlist /*anywheresoftware.b4a.objects.collections.List*/ .Get(_index));
 //BA.debugLineNum = 58;BA.debugLine="bs.alive = False";
...
String _aantal = "";
 //BA.debugLineNum = 110;BA.debugLine="public Sub UpdateBordWhenClient(data As Message)";
 //BA.debugLineNum = 111;BA.debugLine="HideWaitLabel";
_hidewaitlabel();
 //BA.debugLineNum = 112;BA.debugLine="lastMessageTime = DateTime.Now";
_lastmessagetime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 113;BA.debugLine="lblSpelduur.TextColor = Colors.White";
mostCurrent._lblspelduur.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 114;BA.debugLine="Dim Number, str As String";
_number = "";
_str = "";
 //BA.debugLineNum = 115;BA.debugLine="str = data.Body";
_str = _data.Body /*String*/ ;
 //BA.debugLineNum = 117;BA.debugLine="parser.Initialize(str)";
...
_root = mostCurrent._parser.NextObject();
 //BA.debugLineNum = 119;BA.debugLine="Dim score As Map = root.Get(\"score\")";
...
_score = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (anywheresoftware.b4a.objects.collections.Map.MyMap)(_root.Get((Object)("score"))));
 //BA.debugLineNum = 120;BA.debugLine="Dim p1 As Map = score.Get(\"p1\")";
...
_p1 = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (anywheresoftware.b4a.objects.collections.Map.MyMap)(_score.Get((Object)("p1"))));
 //BA.debugLineNum = 121;BA.debugLine="Dim p2 As Map = score.Get(\"p2\")";
...
_p2 = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (anywheresoftware.b4a.objects.collections.Map.MyMap)(_score.Get((Object)("p2"))));
 //BA.debugLineNum = 123;BA.debugLine="Dim aan_stoot As Map = score.Get(\"aan_stoot\")";
...
_aan_stoot = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (anywheresoftware.b4a.objects.collections.Map.MyMap)(_score.Get((Object)("aan_stoot"))));
 //BA.debugLineNum = 124;BA.debugLine="Dim speler As String = aan_stoot.Get(\"speler\")";
_speler = BA.ObjectToString(_aan_stoot.Get((Object)("speler")));
 //BA.debugLineNum = 125;BA.debugLine="Dim spelduur As Map = score.Get(\"spelduur\")";
...
_spelduur = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (anywheresoftware.b4a.objects.collections.Map.MyMap)(_score.Get((Object)("spelduur"))));
 //BA.debugLineNum = 126;BA.debugLine="Dim tijd As String = spelduur.Get(\"tijd\")";
_tijd = BA.ObjectToString(_spelduur.Get((Object)("tijd")));
 //BA.debugLineNum = 127;BA.debugLine="Dim beurten As Map = score.Get(\"beurten\")";
...
_beurten = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (anywheresoftware.b4a.objects.collections.Map.MyMap)(_score.Get((Object)("beurten"))));
 //BA.debugLineNum = 128;BA.debugLine="Dim aantal As String = beurten.Get(\"aantal\")";
_aantal = BA.ObjectToString(_beurten.Get((Object)("aantal")));
 //BA.debugLineNum = 130;BA.debugLine="lblP1Name.Text = p1.Get(\"naam\")";
mostCurrent._lblp1name.setText(BA.ObjectToCharSequence(_p1.Get((Object)("naam"))));
 //BA.debugLineNum = 131;BA.debugLine="Number = p1.Get(\"caram\")";
_number = BA.ObjectToString(_p1.Get((Object)("caram")));
 //BA.debugLineNum = 132;BA.debugLine="lblP1100.Text = Number.SubString2(0,1)";
mostCurrent._lblp1100.setText(BA.ObjectToCharSequence(_number.substring((int) (0),(int) (1))));
 //BA.debugLineNum = 133;BA.debugLine="lblP110.Text = Number.SubString2(1,2)";
mostCurrent._lblp110.setText(BA.ObjectToCharSequence(_number.substring((int) (1),(int) (2))));
 //BA.debugLineNum = 134;BA.debugLine="lblP11.Text = Number.SubString2(2,3)";
mostCurrent._lblp11.setText(BA.ObjectToCharSequence(_number.substring((int) (2),(int) (3))));
 //BA.debugLineNum = 135;BA.debugLine="Number = p1.Get(\"maken\")";
_number = BA.ObjectToString(_p1.Get((Object)("maken")));
 //BA.debugLineNum = 136;BA.debugLine="lblP1Maken100.Text = Number.SubString2(0,1)";
mostCurrent._lblp1maken100.setText(BA.ObjectToCharSequence(_number.substring((int) (0),(int) (1))));
 //BA.debugLineNum = 137;BA.debugLine="lblP1Maken10.Text = Number.SubString2(1,2)";
mostCurrent._lblp1maken10.setText(BA.ObjectToCharSequence(_number.substring((int) (1),(int) (2))));
 //BA.debugLineNum = 138;BA.debugLine="lblP1Maken1.Text = Number.SubString2(2,3)";
mostCurrent._lblp1maken1.setText(BA.ObjectToCharSequence(_number.substring((int) (2),(int) (3))));
 //BA.debugLineNum = 139;BA.debugLine="lblP1Moy.Text = cs.Initialize.Typeface(Typeface.F";
...
_cs.Initialize().Append(BA.ObjectToCharSequence("")).Typeface(anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME()).Append(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.Chr((int) (0xf201)))).PopAll();
 //BA.debugLineNum = 152;BA.debugLine="lblP2Moy.Text = cs.Initialize.Typeface(Typeface.F";
mostCurrent._lblp2moy.setText(BA.ObjectToCharSequence(_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME()).Append(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.Chr((int) (0xf201)))).Append(BA.ObjectToCharSequence("  ")).Append(BA.ObjectToCharSequence(_p2.Get((Object)("moyenne")))).PopAll().getObject()));
 //BA.debugLineNum = 154;BA.debugLine="lblBeurt100.Text = aantal.SubString2(0,1)";
mostCurrent._lblbeurt100.setText(BA.ObjectToCharSequence(_aantal.substring((int) (0),(int) (1))));
 //BA.debugLineNum = 155;BA.debugLine="lblBeurt10.Text = aantal.SubString2(1,2)";
mostCurrent._lblbeurt10.setText(BA.ObjectToCharSequence(_aantal.substring((int) (1),(int) (2))));
 //BA.debugLineNum = 156;BA.debugLine="lblBeurt1.Text = aantal.SubString2(2,3)";
mostCurrent._lblbeurt1.setText(BA.ObjectToCharSequence(_aantal.substring((int) (2),(int) (3))));
 //BA.debugLineNum = 159;BA.debugLine="cs.Initialize.Typeface(Typeface.LoadFromAssets(\"m";
_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("materialdesignicons-webfont.ttf")).Size((int) (20)).Append(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.Chr((int) (0xf150))));
 //BA.debugLineNum = 160;BA.debugLine="cs.Append(\"  \").Typeface(Typeface.LoadFromAssets(";
_cs.Append(BA.ObjectToCharSequence("  ")).Typeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("Baloo2-Regular.ttf")).Size((int) (20)).Append(BA.ObjectToCharSequence(_tijd)).PopAll();
 //BA.debugLineNum = 161;BA.debugLine="lblSpelduur.Text = cs";
